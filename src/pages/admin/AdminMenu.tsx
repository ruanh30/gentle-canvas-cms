...
const HEADER_PRESETS: HeaderPreset[] = [
  ...
  // ── 9. NORDIC — Scandinavian minimalism, light grey tones, generous spacing ──
  {
    id: 'nordic',
    name: 'Nordic',
    tagline: 'Minimalismo escandinavo. Tons neutros, espaçamento generoso, tipografia limpa',
    tags: ['Scandi', 'Arejado'],
    config: {
      layout: 'classic', menuStyle: 'horizontal', menuUppercase: false, menuFontWeight: 400,
      menuFontSize: 14, menuHoverStyle: 'underline', menuSeparator: 'none', menuItemGap: 32,
      menuLetterSpacing: 0.01, menuItemPadding: false,
      headerSurface: false, dropdownElevated: false, borderBottom: false, shadowOnScroll: false,
      iconStrokeWidth: 1.2, height: 72, sticky: true, shrinkOnScroll: false, iconSize: 20,
      showSearch: true, searchStyle: 'modal', showAccount: true, showCart: true, cartBadgeStyle: 'dot',
      menuDividerLine: false,
      menuTypography: { fontFamily: 'DM Sans', fontWeight: 400, fontSizeDesktop: 14, fontSizeMobile: 14, letterSpacing: 0.01, textTransform: 'none', lineHeight: 1.4 },
      container: { width: 'container', maxWidth: 1200, paddingX: 32, gap: 32, verticalAlign: 'center' },
      mobile: { drawerPosition: 'right', showSearchInDrawer: true, showAccountInDrawer: true, showCartInDrawer: false, maxLevels: 2, groupStyle: 'list' },
      search: { placeholder: 'Buscar...', showOnDesktop: true, showOnMobile: true, autoSuggest: false, maxResults: 5, shortcutEnabled: true },
      announcement: { enabled: false },
      menuColors: { linkColor: '#374151', linkHoverColor: '#111827', linkActiveColor: '#111827', linkBg: '', linkHoverBg: '' },
      states: {
        normal: { backgroundColor: '#f9fafb', textColor: '#374151', borderBottom: false, borderColor: 'transparent', shadow: 'none', blur: false, height: 72 },
        sticky: { backgroundColor: '#f9fafb', textColor: '#374151', borderBottom: true, borderColor: '#e5e7eb', shadow: 'subtle', blur: true, height: 64 },
        transparent: { backgroundColor: 'transparent', textColor: '#ffffff', borderBottom: false, borderColor: 'transparent', shadow: 'none', blur: false, height: 72 },
      },
    },
  },

  // ── 10. URBAN — Dark header, bold navigation, streetwear/sneaker store ──
  {
    id: 'urban',
    name: 'Urban',
    tagline: 'Streetwear e sneakers. Header escuro, tipografia bold, energia urbana',
    tags: ['Street', 'Bold'],
    config: {
      layout: 'classic', menuStyle: 'dropdown', menuUppercase: true, menuFontWeight: 700,
      menuFontSize: 13, menuHoverStyle: 'background', menuSeparator: 'none', menuItemGap: 16,
      menuLetterSpacing: 0.08, menuItemPadding: true,
      ...
      showSearch: true, searchStyle: 'modal', showAccount: true, showCart: true, cartBadgeStyle: 'count',
      menuDividerLine: false,
      menuTypography: { fontFamily: 'Montserrat', fontWeight: 700, fontSizeDesktop: 13, fontSizeMobile: 13, letterSpacing: 0.08, textTransform: 'uppercase', lineHeight: 1.2 },
      container: { width: 'full', maxWidth: 1600, paddingX: 20, gap: 16, verticalAlign: 'center' },
      ...
      search: { placeholder: 'BUSCAR', showOnDesktop: true, showOnMobile: true, autoSuggest: true, maxResults: 6, shortcutEnabled: true },
      announcement: { enabled: true, messages: ['DROPS TODA SEXTA 🔥', 'FRETE GRÁTIS ACIMA DE R$299'], speed: 4, backgroundColor: '#ef4444', textColor: '#ffffff', style: 'ticker', direction: 'rtl', showIcon: false, icon: '', link: '', pauseOnHover: true, pageRules: 'all', scheduleEnabled: false, scheduleStart: '', scheduleEnd: '', segmentation: 'all', ctaText: '', ctaLink: '', utmSource: '', utmMedium: '', utmCampaign: '' },
      menuColors: { linkColor: '#f9fafb', linkHoverColor: '#ffffff', linkActiveColor: '#ef4444', linkBg: '', linkHoverBg: 'rgba(255,255,255,0.08)' },
      states: {
        normal: { backgroundColor: '#111827', textColor: '#f9fafb', borderBottom: false, borderColor: 'transparent', shadow: 'medium', blur: false, height: 60 },
        sticky: { backgroundColor: '#0f172a', textColor: '#f9fafb', borderBottom: false, borderColor: 'transparent', shadow: 'strong', blur: true, height: 56 },
        transparent: { backgroundColor: 'transparent', textColor: '#ffffff', borderBottom: false, borderColor: 'transparent', shadow: 'none', blur: false, height: 60 },
      },
    },
  },

  // ── 11. BOUTIQUE — Centered nav-left, elegant serif-feel, soft cream ──
  {
    id: 'boutique',
    name: 'Boutique',
    tagline: 'Loja de bairro chique. Logo central, nav à esquerda, tom cremoso elegante',
    tags: ['Chique', 'Feminino'],
    config: {
      layout: 'logo-center-nav-left', menuStyle: 'horizontal', menuUppercase: true, menuFontWeight: 400,
      menuFontSize: 11, menuHoverStyle: 'underline', menuSeparator: 'point', menuItemGap: 24,
      menuLetterSpacing: 0.18, menuItemPadding: false,
      headerSurface: false, dropdownElevated: false, borderBottom: true, shadowOnScroll: false,
      iconStrokeWidth: 1, height: 72, sticky: true, shrinkOnScroll: true, iconSize: 18,
      showSearch: true, searchStyle: 'modal', showAccount: true, showCart: true, cartBadgeStyle: 'dot',
      menuDividerLine: false,
      menuTypography: { fontFamily: 'Lato', fontWeight: 400, fontSizeDesktop: 11, fontSizeMobile: 12, letterSpacing: 0.18, textTransform: 'uppercase', lineHeight: 1.2 },
      container: { width: 'container', maxWidth: 1280, paddingX: 28, gap: 24, verticalAlign: 'center' },
      mobile: { drawerPosition: 'right', showSearchInDrawer: true, showAccountInDrawer: true, showCartInDrawer: false, maxLevels: 2, groupStyle: 'list' },
      search: { placeholder: 'Pesquisar', showOnDesktop: true, showOnMobile: true, autoSuggest: false, maxResults: 5, shortcutEnabled: false },
      announcement: { enabled: false },
      menuColors: { linkColor: '#44403c', linkHoverColor: '#78716c', linkActiveColor: '#292524', linkBg: '', linkHoverBg: '' },
      states: {
        normal: { backgroundColor: '#faf9f7', textColor: '#44403c', borderBottom: true, borderColor: '#e7e5e4', shadow: 'none', blur: false, height: 72 },
        sticky: { backgroundColor: '#faf9f7', textColor: '#44403c', borderBottom: true, borderColor: '#d6d3d1', shadow: 'subtle', blur: true, height: 56 },
        transparent: { backgroundColor: 'transparent', textColor: '#ffffff', borderBottom: false, borderColor: 'transparent', shadow: 'none', blur: false, height: 72 },
      },
    },
  },

  // ── 12. TECH — Modern tech store, glass effect, blue accent, inline search ──
  {
    id: 'tech',
    name: 'Tech',
    tagline: 'Loja de tecnologia. Efeito glass, acento azul, busca inline, compacto',
    tags: ['Tecnologia', 'Moderno'],
    config: {
      layout: 'classic', menuStyle: 'dropdown', menuUppercase: false, menuFontWeight: 500,
      menuFontSize: 14, menuHoverStyle: 'background', menuSeparator: 'none', menuItemGap: 20,
      menuLetterSpacing: 0, menuItemPadding: true,
      headerSurface: true, dropdownElevated: true, borderBottom: true, shadowOnScroll: true,
      iconStrokeWidth: 1.5, height: 56, sticky: true, shrinkOnScroll: false, iconSize: 20,
      showSearch: true, searchStyle: 'inline', showAccount: true, showCart: true, cartBadgeStyle: 'count',
      menuDividerLine: false,
      menuTypography: { fontFamily: 'Inter', fontWeight: 500, fontSizeDesktop: 14, fontSizeMobile: 13, letterSpacing: 0, textTransform: 'none', lineHeight: 1.2 },
      container: { width: 'container', maxWidth: 1400, paddingX: 16, gap: 16, verticalAlign: 'center' },
      mobile: { drawerPosition: 'left', showSearchInDrawer: true, showAccountInDrawer: true, showCartInDrawer: true, maxLevels: 2, groupStyle: 'accordion' },
      search: { placeholder: 'Buscar produtos e marcas...', showOnDesktop: true, showOnMobile: true, autoSuggest: true, maxResults: 8, shortcutEnabled: true },
      announcement: { enabled: false },
      menuColors: { linkColor: '#1e293b', linkHoverColor: '#2563eb', linkActiveColor: '#2563eb', linkBg: '', linkHoverBg: 'rgba(37,99,235,0.06)' },
      states: {
        normal: { backgroundColor: 'rgba(255,255,255,0.85)', textColor: '#1e293b', borderBottom: true, borderColor: '#e2e8f0', shadow: 'subtle', blur: true, height: 56 },
        sticky: { backgroundColor: 'rgba(255,255,255,0.92)', textColor: '#1e293b', borderBottom: true, borderColor: '#cbd5e1', shadow: 'medium', blur: true, height: 52 },
  ...
  // ── 13. EDITORIAL — Magazine-style, double-row with nav bar, content-first ──
  {
    id: 'editorial',
    name: 'Editorial',
    tagline: 'Estilo revista. Duas linhas, barra de navegação destacada, tipografia editorial',
    tags: ['Revista', 'Conteúdo'],
    config: {
      layout: 'double-row', menuStyle: 'horizontal', menuUppercase: true, menuFontWeight: 500,
      menuFontSize: 11, menuHoverStyle: 'underline', menuSeparator: 'line', menuItemGap: 24,
      menuLetterSpacing: 0.15, menuItemPadding: false,
      headerSurface: false, dropdownElevated: false, borderBottom: true, shadowOnScroll: false,
      iconStrokeWidth: 1.2, height: 64, sticky: true, shrinkOnScroll: true, iconSize: 18,
      showSearch: true, searchStyle: 'modal', showAccount: true, showCart: true, cartBadgeStyle: 'dot',
      menuDividerLine: true,
      menuTypography: { fontFamily: 'Montserrat', fontWeight: 500, fontSizeDesktop: 11, fontSizeMobile: 12, letterSpacing: 0.15, textTransform: 'uppercase', lineHeight: 1.2 },
      container: { width: 'container', maxWidth: 1300, paddingX: 24, gap: 20, verticalAlign: 'center' },
      mobile: { drawerPosition: 'left', showSearchInDrawer: true, showAccountInDrawer: true, showCartInDrawer: false, maxLevels: 2, groupStyle: 'list' },
      megaMenuConfig: { columns: 4, width: 'container', showImages: false, showBanner: false, bannerImageUrl: '', bannerLink: '' },
      search: { placeholder: 'Buscar...', showOnDesktop: true, showOnMobile: true, autoSuggest: false, maxResults: 6, shortcutEnabled: true },
      menuBar: { enabled: true, backgroundColor: '#ffffff', textColor: '#1a1a1a', height: 40, fullWidth: false, borderTop: true, borderBottom: true, shadow: 'none' },
      announcement: { enabled: false },
      menuColors: { linkColor: '#1a1a1a', linkHoverColor: '#525252', linkActiveColor: '#000000', linkBg: '', linkHoverBg: '' },
      states: {
        normal: { backgroundColor: '#ffffff', textColor: '#1a1a1a', borderBottom: true, borderColor: '#d4d4d4', shadow: 'none', blur: false, height: 64 },
        sticky: { backgroundColor: '#ffffff', textColor: '#1a1a1a', borderBottom: true, borderColor: '#d4d4d4', shadow: 'subtle', blur: true, height: 52 },
        transparent: { backgroundColor: 'transparent', textColor: '#ffffff', borderBottom: false, borderColor: 'transparent', shadow: 'none', blur: false, height: 64 },
      },
    },
  },

  // ── 14. ORGANIC — Natural/eco store, earthy greens, warm feel ──
  {
    id: 'organic',
    name: 'Organic',
    tagline: 'Produtos naturais e eco. Tons terrosos, verde orgânico, feeling sustentável',
    tags: ['Natural', 'Eco'],
    config: {
      layout: 'classic', menuStyle: 'horizontal', menuUppercase: false, menuFontWeight: 500,
      menuFontSize: 14, menuHoverStyle: 'underline', menuSeparator: 'none', menuItemGap: 24,
      menuLetterSpacing: 0, menuItemPadding: false,
      headerSurface: false, dropdownElevated: false, borderBottom: true, shadowOnScroll: false,
      iconStrokeWidth: 1.5, height: 64, sticky: true, shrinkOnScroll: true, iconSize: 20,
      showSearch: true, searchStyle: 'modal', showAccount: true, showCart: true, cartBadgeStyle: 'count',
      menuDividerLine: false,
      menuTypography: { fontFamily: 'Nunito Sans', fontWeight: 500, fontSizeDesktop: 14, fontSizeMobile: 14, letterSpacing: 0, textTransform: 'none', lineHeight: 1.3 },
      container: { width: 'container', maxWidth: 1280, paddingX: 24, gap: 20, verticalAlign: 'center' },
      mobile: { drawerPosition: 'right', showSearchInDrawer: true, showAccountInDrawer: true, showCartInDrawer: true, maxLevels: 2, groupStyle: 'accordion' },
      search: { placeholder: 'Buscar produtos naturais...', showOnDesktop: true, showOnMobile: true, autoSuggest: true, maxResults: 6, shortcutEnabled: false },
      announcement: { enabled: true, messages: ['🌿 Produtos 100% naturais e sustentáveis'], speed: 6, backgroundColor: '#14532d', textColor: '#dcfce7', style: 'static', direction: 'rtl', showIcon: false, icon: '', link: '', pauseOnHover: true, pageRules: 'all', scheduleEnabled: false, scheduleStart: '', scheduleEnd: '', segmentation: 'all', ctaText: '', ctaLink: '', utmSource: '', utmMedium: '', utmCampaign: '' },
      menuColors: { linkColor: '#166534', linkHoverColor: '#15803d', linkActiveColor: '#14532d', linkBg: '', linkHoverBg: 'rgba(22,101,52,0.06)' },
      states: {
        normal: { backgroundColor: '#f0fdf4', textColor: '#166534', borderBottom: true, borderColor: '#bbf7d0', shadow: 'none', blur: false, height: 64 },
        sticky: { backgroundColor: '#f0fdf4', textColor: '#166534', borderBottom: true, borderColor: '#86efac', shadow: 'subtle', blur: true, height: 56 },
        transparent: { backgroundColor: 'transparent', textColor: '#ffffff', borderBottom: false, borderColor: 'transparent', shadow: 'none', blur: false, height: 64 },
      },
    },
  },

  // ── 15. SPORT — Dynamic sports store, bold contrast, high energy ──
  {
    id: 'sport',
    name: 'Sport',
    tagline: 'Esportes e performance. Contraste alto, tipografia forte, energia dinâmica',
    tags: ['Esporte', 'Dinâmico'],
    config: {
      layout: 'classic', menuStyle: 'mega-menu', menuUppercase: true, menuFontWeight: 600,
      menuFontSize: 13, menuHoverStyle: 'background', menuSeparator: 'none', menuItemGap: 12,
      menuLetterSpacing: 0.06, menuItemPadding: true,
      headerSurface: true, dropdownElevated: true, borderBottom: false, shadowOnScroll: true,
      iconStrokeWidth: 2, height: 60, sticky: true, shrinkOnScroll: false, iconSize: 22,
      showSearch: true, searchStyle: 'inline', showAccount: true, showCart: true, cartBadgeStyle: 'count',
      menuDividerLine: false,
      menuTypography: { fontFamily: 'Montserrat', fontWeight: 600, fontSizeDesktop: 13, fontSizeMobile: 13, letterSpacing: 0.06, textTransform: 'uppercase', lineHeight: 1.2 },
      container: { width: 'full', maxWidth: 1600, paddingX: 16, gap: 12, verticalAlign: 'center' },
      mobile: { drawerPosition: 'left', showSearchInDrawer: true, showAccountInDrawer: true, showCartInDrawer: true, maxLevels: 3, groupStyle: 'accordion' },
      megaMenuConfig: { columns: 4, width: 'full', showImages: true, showBanner: true, bannerImageUrl: '', bannerLink: '' },
      search: { placeholder: 'Buscar produtos...', showOnDesktop: true, showOnMobile: true, autoSuggest: true, maxResults: 8, shortcutEnabled: true },
      announcement: { enabled: true, messages: ['⚡ SALE: até 60% OFF em selecionados'], speed: 5, backgroundColor: '#000000', textColor: '#facc15', style: 'ticker', direction: 'rtl', showIcon: false, icon: '', link: '', pauseOnHover: true, pageRules: 'all', scheduleEnabled: false, scheduleStart: '', scheduleEnd: '', segmentation: 'all', ctaText: '', ctaLink: '', utmSource: '', utmMedium: '', utmCampaign: '' },
      menuColors: { linkColor: '#fafafa', linkHoverColor: '#ffffff', linkActiveColor: '#facc15', linkBg: '', linkHoverBg: 'rgba(255,255,255,0.1)' },
      states: {
        normal: { backgroundColor: '#18181b', textColor: '#fafafa', borderBottom: false, borderColor: 'transparent', shadow: 'medium', blur: false, height: 60 },
        sticky: { backgroundColor: '#09090b', textColor: '#fafafa', borderBottom: false, borderColor: 'transparent', shadow: 'strong', blur: true, height: 56 },
        transparent: { backgroundColor: 'transparent', textColor: '#ffffff', borderBottom: false, borderColor: 'transparent', shadow: 'none', blur: false, height: 60 },
      },
    },
  },

  // ── 16. GALLERY — Art/furniture, centered, lots of whitespace, minimal nav ──
  {
    id: 'gallery',
    name: 'Gallery',
    tagline: 'Arte e design. Centrado, muito espaço branco, navegação discreta',
    tags: ['Arte', 'Galeria'],
    config: {
      layout: 'centered', menuStyle: 'horizontal', menuUppercase: true, menuFontWeight: 300,
      menuFontSize: 12, menuHoverStyle: 'underline', menuSeparator: 'none', menuItemGap: 40,
      menuLetterSpacing: 0.2, menuItemPadding: false,
      headerSurface: false, dropdownElevated: false, borderBottom: false, shadowOnScroll: false,
      iconStrokeWidth: 1, height: 88, sticky: true, shrinkOnScroll: true, iconSize: 18,
      showSearch: false, searchStyle: 'modal', showAccount: false, showCart: true, cartBadgeStyle: 'dot',
      menuDividerLine: false,
      menuTypography: { fontFamily: 'DM Sans', fontWeight: 300, fontSizeDesktop: 12, fontSizeMobile: 12, letterSpacing: 0.2, textTransform: 'uppercase', lineHeight: 1.2 },
      container: { width: 'container', maxWidth: 1200, paddingX: 40, gap: 40, verticalAlign: 'center' },
      mobile: { drawerPosition: 'left', showSearchInDrawer: false, showAccountInDrawer: false, showCartInDrawer: true, maxLevels: 2, groupStyle: 'list' },
      search: { placeholder: 'Buscar', showOnDesktop: false, showOnMobile: true, autoSuggest: false, maxResults: 4, shortcutEnabled: false },
      announcement: { enabled: false },
      menuColors: { linkColor: '#525252', linkHoverColor: '#171717', linkActiveColor: '#171717', linkBg: '', linkHoverBg: '' },
      states: {
        normal: { backgroundColor: '#ffffff', textColor: '#525252', borderBottom: false, borderColor: 'transparent', shadow: 'none', blur: false, height: 88 },
        sticky: { backgroundColor: '#ffffff', textColor: '#525252', borderBottom: true, borderColor: '#f5f5f5', shadow: 'none', blur: true, height: 64 },
        transparent: { backgroundColor: 'transparent', textColor: '#ffffff', borderBottom: false, borderColor: 'transparent', shadow: 'none', blur: false, height: 88 },
      },
    },
  },

  // ── 17. DEPARTMENT — Large retailer, top-bar-split, category-focused ──
  {
    id: 'department',
    name: 'Department',
    tagline: 'Grande varejista. Barra dividida, mega menu por departamento, funcional',
    tags: ['Varejo', 'Categorias'],
    config: {
      layout: 'top-bar-split', menuStyle: 'mega-menu', menuUppercase: false, menuFontWeight: 500,
      menuFontSize: 14, menuHoverStyle: 'both', menuSeparator: 'none', menuItemGap: 8,
      menuLetterSpacing: 0, menuItemPadding: true,
      headerSurface: true, dropdownElevated: true, borderBottom: true, shadowOnScroll: true,
      iconStrokeWidth: 1.5, height: 56, sticky: true, shrinkOnScroll: false, iconSize: 20,
      showSearch: true, searchStyle: 'inline', showAccount: true, showCart: true, cartBadgeStyle: 'count',
      menuDividerLine: false,
      menuTypography: { fontFamily: 'Rubik', fontWeight: 500, fontSizeDesktop: 14, fontSizeMobile: 14, letterSpacing: 0, textTransform: 'none', lineHeight: 1.2 },
      container: { width: 'full', maxWidth: 1600, paddingX: 16, gap: 12, verticalAlign: 'center' },
      mobile: { drawerPosition: 'left', showSearchInDrawer: true, showAccountInDrawer: true, showCartInDrawer: true, maxLevels: 3, groupStyle: 'accordion' },
      megaMenuConfig: { columns: 6, width: 'full', showImages: true, showBanner: true, bannerImageUrl: '', bannerLink: '' },
      search: { placeholder: 'Buscar em todos os departamentos...', showOnDesktop: true, showOnMobile: true, autoSuggest: true, maxResults: 10, shortcutEnabled: true },
      menuBar: { enabled: true, backgroundColor: '#1e40af', textColor: '#ffffff', height: 44, fullWidth: true, borderTop: false, borderBottom: false, shadow: 'none' },
      announcement: { enabled: true, messages: ['Ofertas do dia com até 70% OFF', 'Frete grátis para todo o Brasil'], speed: 4, backgroundColor: '#fef08a', textColor: '#713f12', style: 'carousel', direction: 'rtl', showIcon: false, icon: '', link: '', pauseOnHover: true, pageRules: 'all', scheduleEnabled: false, scheduleStart: '', scheduleEnd: '', segmentation: 'all', ctaText: '', ctaLink: '', utmSource: '', utmMedium: '', utmCampaign: '' },
      menuColors: { linkColor: '#ffffff', linkHoverColor: '#ffffff', linkActiveColor: '#fbbf24', linkBg: '', linkHoverBg: 'rgba(255,255,255,0.12)' },
      states: {
        normal: { backgroundColor: '#ffffff', textColor: '#1e293b', borderBottom: true, borderColor: '#e2e8f0', shadow: 'subtle', blur: false, height: 56 },
        sticky: { backgroundColor: '#ffffff', textColor: '#1e293b', borderBottom: true, borderColor: '#cbd5e1', shadow: 'medium', blur: true, height: 52 },
        transparent: { backgroundColor: 'transparent', textColor: '#ffffff', borderBottom: false, borderColor: 'transparent', shadow: 'none', blur: false, height: 56 },
      },
    },
  },

  // ── 18. MONO — Pure black & white, high contrast, typographic focus ──
  {
    id: 'mono',
    name: 'Mono',
    tagline: 'Preto e branco puro. Alto contraste, foco tipográfico, sem distrações',
    tags: ['B&W', 'Contraste'],
    config: {
      layout: 'classic', menuStyle: 'horizontal', menuUppercase: true, menuFontWeight: 600,
      menuFontSize: 12, menuHoverStyle: 'underline', menuSeparator: 'bar', menuItemGap: 20,
      menuLetterSpacing: 0.12, menuItemPadding: false,
      headerSurface: false, dropdownElevated: false, borderBottom: true, shadowOnScroll: false,
      iconStrokeWidth: 1.5, height: 56, sticky: true, shrinkOnScroll: false, iconSize: 18,
      showSearch: true, searchStyle: 'modal', showAccount: true, showCart: true, cartBadgeStyle: 'count',
      menuDividerLine: true,
      menuTypography: { fontFamily: 'Manrope', fontWeight: 600, fontSizeDesktop: 12, fontSizeMobile: 12, letterSpacing: 0.12, textTransform: 'uppercase', lineHeight: 1.2 },
      container: { width: 'container', maxWidth: 1280, paddingX: 20, gap: 20, verticalAlign: 'center' },
      mobile: { drawerPosition: 'right', showSearchInDrawer: true, showAccountInDrawer: true, showCartInDrawer: true, maxLevels: 2, groupStyle: 'list' },
      search: { placeholder: 'BUSCAR', showOnDesktop: true, showOnMobile: true, autoSuggest: false, maxResults: 6, shortcutEnabled: true },
      announcement: { enabled: false },
      menuColors: { linkColor: '#000000', linkHoverColor: '#525252', linkActiveColor: '#000000', linkBg: '', linkHoverBg: '' },
      states: {
        normal: { backgroundColor: '#ffffff', textColor: '#000000', borderBottom: true, borderColor: '#000000', shadow: 'none', blur: false, height: 56 },
  ...
  // ── 19. FRESH — Bright colors, playful, youth brand ──
  {
    id: 'fresh',
    name: 'Fresh',
    tagline: 'Marca jovem e vibrante. Cores alegres, tipografia arredondada, playful',
    tags: ['Jovem', 'Colorido'],
    config: {
      ...
      showSearch: true, searchStyle: 'inline', showAccount: true, showCart: true, cartBadgeStyle: 'count',
      menuDividerLine: false,
      menuTypography: { fontFamily: 'Nunito Sans', fontWeight: 600, fontSizeDesktop: 15, fontSizeMobile: 14, letterSpacing: 0, textTransform: 'none', lineHeight: 1.3 },
      container: { width: 'container', maxWidth: 1400, paddingX: 20, gap: 16, verticalAlign: 'center' },
      mobile: { drawerPosition: 'right', showSearchInDrawer: true, showAccountInDrawer: true, showCartInDrawer: true, maxLevels: 2, groupStyle: 'accordion' },
      search: { placeholder: 'O que você quer encontrar? 🔍', showOnDesktop: true, showOnMobile: true, autoSuggest: true, maxResults: 6, shortcutEnabled: true },
      announcement: { enabled: true, messages: ['🎉 Primeira compra com 15% OFF!', '✨ Novidades toda semana'], speed: 5, backgroundColor: '#7c3aed', textColor: '#ffffff', style: 'carousel', direction: 'rtl', showIcon: false, icon: '', link: '', pauseOnHover: true, pageRules: 'all', scheduleEnabled: false, scheduleStart: '', scheduleEnd: '', segmentation: 'all', ctaText: '', ctaLink: '', utmSource: '', utmMedium: '', utmCampaign: '' },
  ...
  // ── 20. WAREHOUSE — No-frills, dense, utility-first, everything visible ──
  {
    id: 'warehouse',
    name: 'Warehouse',
    tagline: 'Utilitário sem frescura. Denso, tudo visível, foco em eficiência',
    tags: ['Utilitário', 'Denso'],
    config: {
      layout: 'double-row', menuStyle: 'dropdown', menuUppercase: false, menuFontWeight: 500,
      menuFontSize: 13, menuHoverStyle: 'background', menuSeparator: 'none', menuItemGap: 8,
      menuLetterSpacing: 0, menuItemPadding: true,
      headerSurface: true, dropdownElevated: true, borderBottom: true, shadowOnScroll: true,
      iconStrokeWidth: 1.5, height: 52, sticky: true, shrinkOnScroll: false, iconSize: 20,
      showSearch: true, searchStyle: 'inline', showAccount: true, showCart: true, cartBadgeStyle: 'count',
      menuDividerLine: false,
      menuTypography: { fontFamily: 'Inter', fontWeight: 500, fontSizeDesktop: 13, fontSizeMobile: 13, letterSpacing: 0, textTransform: 'none', lineHeight: 1.2 },
      container: { width: 'full', maxWidth: 1920, paddingX: 12, gap: 8, verticalAlign: 'center' },
      mobile: { drawerPosition: 'left', showSearchInDrawer: true, showAccountInDrawer: true, showCartInDrawer: true, maxLevels: 3, groupStyle: 'accordion' },
      search: { placeholder: 'Código, nome ou marca...', showOnDesktop: true, showOnMobile: true, autoSuggest: true, maxResults: 10, shortcutEnabled: true },
      menuBar: { enabled: true, backgroundColor: '#f1f5f9', textColor: '#334155', height: 40, fullWidth: true, borderTop: false, borderBottom: true, shadow: 'none' },
      announcement: { enabled: true, messages: ['Atacado e varejo — preços imbatíveis'], speed: 6, backgroundColor: '#0f172a', textColor: '#e2e8f0', style: 'static', direction: 'rtl', showIcon: false, icon: '', link: '', pauseOnHover: true, pageRules: 'all', scheduleEnabled: false, scheduleStart: '', scheduleEnd: '', segmentation: 'all', ctaText: '', ctaLink: '', utmSource: '', utmMedium: '', utmCampaign: '' },
      menuColors: { linkColor: '#334155', linkHoverColor: '#0f172a', linkActiveColor: '#0f172a', linkBg: '', linkHoverBg: 'rgba(0,0,0,0.04)' },
      states: {
        normal: { backgroundColor: '#ffffff', textColor: '#334155', borderBottom: true, borderColor: '#e2e8f0', shadow: 'subtle', blur: false, height: 52 },
        sticky: { backgroundColor: '#f8fafc', textColor: '#334155', borderBottom: true, borderColor: '#cbd5e1', shadow: 'medium', blur: true, height: 48 },
        transparent: { backgroundColor: 'transparent', textColor: '#ffffff', borderBottom: false, borderColor: 'transparent', shadow: 'none', blur: false, height: 52 },
      },
    },
  },

  // ── 21. JEWEL — Deep jewel tones, elegant, centered ──
  {
    id: 'jewel',
    name: 'Jewel',
    tagline: 'Joalheria e acessórios finos. Tons profundos, elegância clássica, premium',
    tags: ['Joias', 'Premium'],
    config: {
      layout: 'centered', menuStyle: 'horizontal', menuUppercase: true, menuFontWeight: 400,
      menuFontSize: 11, menuHoverStyle: 'underline', menuSeparator: 'point', menuItemGap: 32,
      menuLetterSpacing: 0.2, menuItemPadding: false,
      headerSurface: false, dropdownElevated: false, borderBottom: true, shadowOnScroll: false,
      iconStrokeWidth: 1, height: 76, sticky: true, shrinkOnScroll: true, iconSize: 18,
      showSearch: true, searchStyle: 'modal', showAccount: true, showCart: true, cartBadgeStyle: 'dot',
      menuDividerLine: true,
      menuTypography: { fontFamily: 'Lato', fontWeight: 400, fontSizeDesktop: 11, fontSizeMobile: 12, letterSpacing: 0.2, textTransform: 'uppercase', lineHeight: 1.2 },
      container: { width: 'container', maxWidth: 1280, paddingX: 32, gap: 28, verticalAlign: 'center' },
      mobile: { drawerPosition: 'right', showSearchInDrawer: true, showAccountInDrawer: true, showCartInDrawer: false, maxLevels: 2, groupStyle: 'list' },
      search: { placeholder: 'Pesquisar joias...', showOnDesktop: true, showOnMobile: true, autoSuggest: false, maxResults: 5, shortcutEnabled: false },
      announcement: { enabled: false },
      menuColors: { linkColor: '#e2d8c8', linkHoverColor: '#ffffff', linkActiveColor: '#d4a853', linkBg: '', linkHoverBg: '' },
      states: {
        normal: { backgroundColor: '#1c1917', textColor: '#e2d8c8', borderBottom: true, borderColor: '#44403c', shadow: 'none', blur: false, height: 76 },
        sticky: { backgroundColor: '#0c0a09', textColor: '#e2d8c8', borderBottom: true, borderColor: '#292524', shadow: 'subtle', blur: true, height: 60 },
        transparent: { backgroundColor: 'transparent', textColor: '#ffffff', borderBottom: false, borderColor: 'transparent', shadow: 'none', blur: false, height: 76 },
      },
    },
  },

  // ── 22. CANDY — Playful pastel pink, rounded feel, candy/toy store ──
  {
    id: 'candy',
    name: 'Candy',
    tagline: 'Doce e divertido. Rosa candy, feeling lúdico, infantil ou doces',
    tags: ['Lúdico', 'Doce'],
    config: {
      ...
      showSearch: true, searchStyle: 'inline', showAccount: true, showCart: true, cartBadgeStyle: 'count',
      menuDividerLine: false,
      menuTypography: { fontFamily: 'Poppins', fontWeight: 600, fontSizeDesktop: 14, fontSizeMobile: 14, letterSpacing: 0, textTransform: 'none', lineHeight: 1.3 },
      container: { width: 'container', maxWidth: 1300, paddingX: 20, gap: 16, verticalAlign: 'center' },
      mobile: { drawerPosition: 'right', showSearchInDrawer: true, showAccountInDrawer: true, showCartInDrawer: true, maxLevels: 2, groupStyle: 'accordion' },
      search: { placeholder: 'O que você quer? 🍬', showOnDesktop: true, showOnMobile: true, autoSuggest: true, maxResults: 6, shortcutEnabled: false },
      announcement: { enabled: true, messages: ['🍭 Frete grátis em pedidos acima de R$99!'], speed: 6, backgroundColor: '#f472b6', textColor: '#ffffff', style: 'static', direction: 'rtl', showIcon: false, icon: '', link: '', pauseOnHover: true, pageRules: 'all', scheduleEnabled: false, scheduleStart: '', scheduleEnd: '', segmentation: 'all', ctaText: '', ctaLink: '', utmSource: '', utmMedium: '', utmCampaign: '' },
      menuColors: { linkColor: '#9d174d', linkHoverColor: '#be185d', linkActiveColor: '#9d174d', linkBg: '', linkHoverBg: 'rgba(244,114,182,0.12)' },
      states: {
  ...
  // ── 23. CAFE — Warm coffee tones, cozy, food/beverage store ──
  {
    id: 'cafe',
    name: 'Café',
    tagline: 'Cafeteria e gastronomia. Tons quentes de café, acolhedor e convidativo',
    tags: ['Food', 'Acolhedor'],
    config: {
      layout: 'classic', menuStyle: 'horizontal', menuUppercase: false, menuFontWeight: 500,
      menuFontSize: 14, menuHoverStyle: 'underline', menuSeparator: 'none', menuItemGap: 24,
      ...
      showSearch: true, searchStyle: 'modal', showAccount: true, showCart: true, cartBadgeStyle: 'count',
      menuDividerLine: false,
      menuTypography: { fontFamily: 'DM Sans', fontWeight: 500, fontSizeDesktop: 14, fontSizeMobile: 14, letterSpacing: 0.01, textTransform: 'none', lineHeight: 1.3 },
      container: { width: 'container', maxWidth: 1200, paddingX: 24, gap: 20, verticalAlign: 'center' },
      mobile: { drawerPosition: 'right', showSearchInDrawer: true, showAccountInDrawer: true, showCartInDrawer: true, maxLevels: 2, groupStyle: 'list' },
      search: { placeholder: 'Buscar cafés e produtos...', showOnDesktop: true, showOnMobile: true, autoSuggest: true, maxResults: 6, shortcutEnabled: false },
      announcement: { enabled: false },
      menuColors: { linkColor: '#78350f', linkHoverColor: '#92400e', linkActiveColor: '#451a03', linkBg: '', linkHoverBg: '' },
      states: {
        normal: { backgroundColor: '#fefce8', textColor: '#78350f', borderBottom: true, borderColor: '#fde68a', shadow: 'none', blur: false, height: 64 },
        sticky: { backgroundColor: '#fefce8', textColor: '#78350f', borderBottom: true, borderColor: '#fbbf24', shadow: 'subtle', blur: true, height: 56 },
        transparent: { backgroundColor: 'transparent', textColor: '#ffffff', borderBottom: false, borderColor: 'transparent', shadow: 'none', blur: false, height: 64 },
      },
    },
  },

  // ── 24. SLATE — Corporate, professional, sidebar-nav layout ──
  {
    id: 'slate',
    name: 'Slate',
    tagline: 'Corporativo e profissional. Sidebar nav, tom neutro, confiança empresarial',
    tags: ['Corporate', 'Pro'],
    config: {
      layout: 'sidebar-nav', menuStyle: 'horizontal', menuUppercase: false, menuFontWeight: 500,
      menuFontSize: 14, menuHoverStyle: 'background', menuSeparator: 'none', menuItemGap: 16,
      menuLetterSpacing: 0, menuItemPadding: true,
      headerSurface: true, dropdownElevated: true, borderBottom: true, shadowOnScroll: true,
      iconStrokeWidth: 1.5, height: 56, sticky: true, shrinkOnScroll: false, iconSize: 20,
      showSearch: true, searchStyle: 'inline', showAccount: true, showCart: true, cartBadgeStyle: 'count',
      ...
      container: { width: 'container', maxWidth: 1400, paddingX: 16, gap: 16, verticalAlign: 'center' },
      mobile: { drawerPosition: 'left', showSearchInDrawer: true, showAccountInDrawer: true, showCartInDrawer: true, maxLevels: 2, groupStyle: 'accordion' },
      search: { placeholder: 'Buscar...', showOnDesktop: true, showOnMobile: true, autoSuggest: true, maxResults: 8, shortcutEnabled: true },
      announcement: { enabled: false },
      menuColors: { linkColor: '#334155', linkHoverColor: '#0f172a', linkActiveColor: '#0f172a', linkBg: '', linkHoverBg: 'rgba(15,23,42,0.04)' },
      states: {
        normal: { backgroundColor: '#f8fafc', textColor: '#334155', borderBottom: true, borderColor: '#e2e8f0', shadow: 'subtle', blur: false, height: 56 },
        sticky: { backgroundColor: '#f1f5f9', textColor: '#334155', borderBottom: true, borderColor: '#cbd5e1', shadow: 'medium', blur: true, height: 52 },
        transparent: { backgroundColor: 'transparent', textColor: '#ffffff', borderBottom: false, borderColor: 'transparent', shadow: 'none', blur: false, height: 56 },
      },
    },
  },

  // ── 25. NEON — Dark background, neon accents, gaming/tech ──
  {
    id: 'neon',
    name: 'Neon',
    tagline: 'Gaming e tech. Fundo escuro, acento neon verde, estética cyberpunk',
    tags: ['Gaming', 'Neon'],
    config: {
      ...
      showSearch: true, searchStyle: 'inline', showAccount: true, showCart: true, cartBadgeStyle: 'count',
      menuDividerLine: false,
      menuTypography: { fontFamily: 'Manrope', fontWeight: 600, fontSizeDesktop: 13, fontSizeMobile: 13, letterSpacing: 0.08, textTransform: 'uppercase', lineHeight: 1.2 },
      container: { width: 'full', maxWidth: 1600, paddingX: 16, gap: 12, verticalAlign: 'center' },
      mobile: { drawerPosition: 'left', showSearchInDrawer: true, showAccountInDrawer: true, showCartInDrawer: true, maxLevels: 2, groupStyle: 'accordion' },
      search: { placeholder: 'BUSCAR PRODUTOS...', showOnDesktop: true, showOnMobile: true, autoSuggest: true, maxResults: 8, shortcutEnabled: true },
      announcement: { enabled: true, messages: ['🎮 MEGA SALE — até 70% OFF em periféricos'], speed: 4, backgroundColor: '#22c55e', textColor: '#052e16', style: 'ticker', direction: 'rtl', showIcon: false, icon: '', link: '', pauseOnHover: true, pageRules: 'all', scheduleEnabled: false, scheduleStart: '', scheduleEnd: '', segmentation: 'all', ctaText: '', ctaLink: '', utmSource: '', utmMedium: '', utmCampaign: '' },
      menuColors: { linkColor: '#d1d5db', linkHoverColor: '#22c55e', linkActiveColor: '#22c55e', linkBg: '', linkHoverBg: 'rgba(34,197,94,0.1)' },
      states: {
        normal: { backgroundColor: '#0a0a0a', textColor: '#d1d5db', borderBottom: true, borderColor: '#1f2937', shadow: 'medium', blur: false, height: 56 },
        sticky: { backgroundColor: '#000000', textColor: '#d1d5db', borderBottom: true, borderColor: '#22c55e', shadow: 'strong', blur: true, height: 52 },
        transparent: { backgroundColor: 'transparent', textColor: '#ffffff', borderBottom: false, borderColor: 'transparent', shadow: 'none', blur: false, height: 56 },
      },
    },
  },

  // ── 26. SILK — Ultra-premium, transparent, thin lines, understated luxury ──
  {
    id: 'silk',
    name: 'Silk',
    tagline: 'Ultra-premium discreto. Transparente, linhas finas, luxo understated',
    tags: ['Discreto', 'Ultra-Luxo'],
    config: {
      layout: 'transparent', menuStyle: 'horizontal', menuUppercase: true, menuFontWeight: 300,
      menuFontSize: 10, menuHoverStyle: 'underline', menuSeparator: 'none', menuItemGap: 36,
      menuLetterSpacing: 0.25, menuItemPadding: false,
      headerSurface: false, dropdownElevated: false, borderBottom: false, shadowOnScroll: false,
      iconStrokeWidth: 1, height: 84, sticky: true, shrinkOnScroll: true, iconSize: 16,
      showSearch: false, searchStyle: 'modal', showAccount: true, showCart: true, cartBadgeStyle: 'dot',
      menuDividerLine: false,
      menuTypography: { fontFamily: 'Lato', fontWeight: 300, fontSizeDesktop: 10, fontSizeMobile: 11, letterSpacing: 0.25, textTransform: 'uppercase', lineHeight: 1.2 },
      container: { width: 'container', maxWidth: 1400, paddingX: 48, gap: 40, verticalAlign: 'center' },
      mobile: { drawerPosition: 'left', showSearchInDrawer: true, showAccountInDrawer: true, showCartInDrawer: false, maxLevels: 2, groupStyle: 'list' },
      search: { placeholder: 'Pesquisar', showOnDesktop: false, showOnMobile: true, autoSuggest: false, maxResults: 4, shortcutEnabled: false },
      announcement: { enabled: false },
      menuColors: { linkColor: '', linkHoverColor: '', linkActiveColor: '', linkBg: '', linkHoverBg: '' },
      states: {
        normal: { backgroundColor: 'transparent', textColor: '#ffffff', borderBottom: false, borderColor: 'transparent', shadow: 'none', blur: false, height: 84 },
        sticky: { backgroundColor: 'rgba(255,255,255,0.96)', textColor: '#1a1a1a', borderBottom: true, borderColor: '#e5e7eb', shadow: 'none', blur: true, height: 52 },
        transparent: { backgroundColor: 'transparent', textColor: '#ffffff', borderBottom: false, borderColor: 'transparent', shadow: 'none', blur: false, height: 84 },
      },
    },
  },

  // ── 27. METRO — Windows Metro-inspired, flat, colored blocks, bold ──
  {
    id: 'metro',
    name: 'Metro',
    tagline: 'Inspirado no Metro UI. Flat, blocos coloridos, tipografia bold moderna',
    tags: ['Flat', 'Bold'],
    config: {
      layout: 'classic', menuStyle: 'dropdown', menuUppercase: true, menuFontWeight: 600,
      menuFontSize: 14, menuHoverStyle: 'background', menuSeparator: 'none', menuItemGap: 4,
      menuLetterSpacing: 0.04, menuItemPadding: true,
      headerSurface: true, dropdownElevated: true, borderBottom: false, shadowOnScroll: false,
      iconStrokeWidth: 2, height: 56, sticky: true, shrinkOnScroll: false, iconSize: 22,
      showSearch: true, searchStyle: 'inline', showAccount: true, showCart: true, cartBadgeStyle: 'count',
      menuDividerLine: false,
      menuTypography: { fontFamily: 'Rubik', fontWeight: 600, fontSizeDesktop: 14, fontSizeMobile: 14, letterSpacing: 0.04, textTransform: 'uppercase', lineHeight: 1.2 },
      container: { width: 'full', maxWidth: 1920, paddingX: 16, gap: 8, verticalAlign: 'center' },
      mobile: { drawerPosition: 'left', showSearchInDrawer: true, showAccountInDrawer: true, showCartInDrawer: true, maxLevels: 2, groupStyle: 'accordion' },
      search: { placeholder: 'Buscar...', showOnDesktop: true, showOnMobile: true, autoSuggest: true, maxResults: 8, shortcutEnabled: true },
      announcement: { enabled: false },
      menuColors: { linkColor: '#ffffff', linkHoverColor: '#ffffff', linkActiveColor: '#ffffff', linkBg: '', linkHoverBg: 'rgba(255,255,255,0.15)' },
      states: {
        normal: { backgroundColor: '#2563eb', textColor: '#ffffff', borderBottom: false, borderColor: 'transparent', shadow: 'none', blur: false, height: 56 },
        sticky: { backgroundColor: '#1d4ed8', textColor: '#ffffff', borderBottom: false, borderColor: 'transparent', shadow: 'medium', blur: true, height: 52 },
        transparent: { backgroundColor: 'transparent', textColor: '#ffffff', borderBottom: false, borderColor: 'transparent', shadow: 'none', blur: false, height: 56 },
      },
    },
  },

  // ── 28. EARTH — Warm earthy browns, artisanal, handcrafted feel ──
  {
    id: 'earth',
    name: 'Earth',
    tagline: 'Artesanal e orgânico. Marrons terrosos, feeling handcrafted e autêntico',
    tags: ['Artesanal', 'Terroso'],
    config: {
      layout: 'classic', menuStyle: 'horizontal', menuUppercase: false, menuFontWeight: 500,
      menuFontSize: 14, menuHoverStyle: 'underline', menuSeparator: 'point', menuItemGap: 24,
      menuLetterSpacing: 0.02, menuItemPadding: false,
      headerSurface: false, dropdownElevated: false, borderBottom: true, shadowOnScroll: false,
      iconStrokeWidth: 1.5, height: 64, sticky: true, shrinkOnScroll: true, iconSize: 20,
      showSearch: true, searchStyle: 'modal', showAccount: true, showCart: true, cartBadgeStyle: 'count',
      menuDividerLine: false,
      menuTypography: { fontFamily: 'DM Sans', fontWeight: 500, fontSizeDesktop: 14, fontSizeMobile: 14, letterSpacing: 0.02, textTransform: 'none', lineHeight: 1.3 },
      container: { width: 'container', maxWidth: 1200, paddingX: 24, gap: 20, verticalAlign: 'center' },
      mobile: { drawerPosition: 'right', showSearchInDrawer: true, showAccountInDrawer: true, showCartInDrawer: true, maxLevels: 2, groupStyle: 'list' },
      search: { placeholder: 'Buscar produtos artesanais...', showOnDesktop: true, showOnMobile: true, autoSuggest: false, maxResults: 5, shortcutEnabled: false },
      announcement: { enabled: false },
      menuColors: { linkColor: '#57534e', linkHoverColor: '#292524', linkActiveColor: '#292524', linkBg: '', linkHoverBg: '' },
      states: {
        normal: { backgroundColor: '#faf5f0', textColor: '#57534e', borderBottom: true, borderColor: '#d6cdc5', shadow: 'none', blur: false, height: 64 },
        sticky: { backgroundColor: '#faf5f0', textColor: '#57534e', borderBottom: true, borderColor: '#c4b8ac', shadow: 'subtle', blur: true, height: 56 },
        transparent: { backgroundColor: 'transparent', textColor: '#ffffff', borderBottom: false, borderColor: 'transparent', shadow: 'none', blur: false, height: 64 },
      },
    },
  },
