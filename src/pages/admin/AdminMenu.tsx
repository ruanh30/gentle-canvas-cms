...
const HEADER_PRESETS: HeaderPreset[] = [
  ...
  // ── 14 NEW PRESETS ──
  {
    id: 'glassmorphism',
    name: 'Glass',
    tagline: 'Transparência com blur elegante',
    tags: ['Moderno', 'Leve'],
    config: {
      ...
      states: {
        normal: { backgroundColor: 'rgba(255,255,255,0.7)', textColor: '#1a1a1a', borderBottom: true, borderColor: 'rgba(255,255,255,0.3)', shadow: 'subtle', blur: true, height: 60 },
        sticky: { backgroundColor: 'rgba(255,255,255,0.85)', textColor: '#1a1a1a', borderBottom: true, borderColor: 'rgba(255,255,255,0.4)', shadow: 'medium', blur: true, height: 52 },
  ...
  },
  {
    id: 'dark-editorial',
    name: 'Editorial',
    tagline: 'Fundo escuro, tipografia bold',
    tags: ['Magazine', 'Bold'],
    config: {
      layout: 'classic', menuStyle: 'horizontal', menuUppercase: true, menuFontWeight: 700,
      menuFontSize: 12, menuHoverStyle: 'underline', menuSeparator: 'line', menuItemGap: 28,
      menuLetterSpacing: 0.18, headerSurface: false, borderBottom: true, shadowOnScroll: false,
      iconStrokeWidth: 1.5, height: 64, sticky: true, shrinkOnScroll: true, iconSize: 18,
      showSearch: true, searchStyle: 'modal', showAccount: true, showWishlist: true, showCart: true, cartBadgeStyle: 'count',
      states: {
        normal: { backgroundColor: '#111111', textColor: '#f5f5f5', borderBottom: true, borderColor: '#2a2a2a', shadow: 'none', blur: false, height: 64 },
        sticky: { backgroundColor: '#0a0a0a', textColor: '#f5f5f5', borderBottom: true, borderColor: '#222222', shadow: 'medium', blur: false, height: 52 },
        transparent: { backgroundColor: 'transparent', textColor: '#ffffff', borderBottom: false, borderColor: 'transparent', shadow: 'none', blur: false, height: 64 },
      },
    },
  },
  {
    id: 'warm-minimal',
    name: 'Warm',
    tagline: 'Tom quente, acolhedor',
    tags: ['Orgânico', 'Suave'],
    config: {
      layout: 'classic', menuStyle: 'horizontal', menuUppercase: false, menuFontWeight: 400,
      menuFontSize: 14, menuHoverStyle: 'underline', menuSeparator: 'none', menuItemGap: 24,
      headerSurface: false, borderBottom: true, shadowOnScroll: false, iconStrokeWidth: 1.5,
      height: 60, sticky: true, shrinkOnScroll: false, iconSize: 20,
      showSearch: true, searchStyle: 'modal', showAccount: true, showWishlist: false, showCart: true, cartBadgeStyle: 'count',
      states: {
        normal: { backgroundColor: '#faf7f2', textColor: '#3d2e1f', borderBottom: true, borderColor: '#e8dfd4', shadow: 'none', blur: false, height: 60 },
        sticky: { backgroundColor: '#faf7f2', textColor: '#3d2e1f', borderBottom: true, borderColor: '#d4c8b8', shadow: 'subtle', blur: true, height: 54 },
        transparent: { backgroundColor: 'transparent', textColor: '#ffffff', borderBottom: false, borderColor: 'transparent', shadow: 'none', blur: false, height: 60 },
      },
    },
  },
  {
    id: 'neon-dark',
    name: 'Neon',
    tagline: 'Estilo gamer/tech vibrante',
    tags: ['Vibrante', 'Futurista'],
    config: {
      ...
      menuLetterSpacing: 0.12, headerSurface: false, borderBottom: true, shadowOnScroll: false,
      dropdownElevated: true, iconStrokeWidth: 2, height: 56, sticky: true, shrinkOnScroll: true, iconSize: 18,
      showSearch: true, searchStyle: 'modal', showAccount: true, showWishlist: false, showCart: true, cartBadgeStyle: 'count',
      states: {
        normal: { backgroundColor: '#0d0d0d', textColor: '#00ff88', borderBottom: true, borderColor: '#00ff8820', shadow: 'none', blur: false, height: 56 },
        sticky: { backgroundColor: '#0a0a0a', textColor: '#00ff88', borderBottom: true, borderColor: '#00ff8830', shadow: 'medium', blur: false, height: 48 },
  ...
  },
  {
    id: 'pill-nav',
    name: 'Pill Nav',
    tagline: 'Menu com items arredondados',
    tags: ['Playful', 'App-like'],
    config: {
      layout: 'classic', menuStyle: 'horizontal', menuUppercase: false, menuFontWeight: 500,
      ...
      shadowOnScroll: true, iconStrokeWidth: 1.5, height: 60, sticky: true, shrinkOnScroll: true, iconSize: 20,
      showSearch: true, searchStyle: 'inline', showAccount: true, showWishlist: false, showCart: true, cartBadgeStyle: 'count',
      states: {
        normal: { backgroundColor: '#ffffff', textColor: '#1a1a1a', borderBottom: true, borderColor: '#f0f0f0', shadow: 'none', blur: false, height: 60 },
        sticky: { backgroundColor: '#ffffff', textColor: '#1a1a1a', borderBottom: true, borderColor: '#e5e7eb', shadow: 'subtle', blur: true, height: 52 },
        transparent: { backgroundColor: 'transparent', textColor: '#ffffff', borderBottom: false, borderColor: 'transparent', shadow: 'none', blur: false, height: 60 },
      },
    },
  },
  {
    id: 'split-tone',
    name: 'Split Tone',
    tagline: 'Linha dupla bicolor elegante',
    tags: ['Dual-tone', 'Estruturado'],
    config: {
      layout: 'double-row', menuStyle: 'dropdown', menuUppercase: true, menuFontWeight: 500,
      menuFontSize: 12, menuHoverStyle: 'both', menuSeparator: 'none', menuItemGap: 20,
      menuLetterSpacing: 0.06, headerSurface: true, dropdownElevated: true, borderBottom: true,
      shadowOnScroll: true, iconStrokeWidth: 1.5, height: 56, sticky: true, shrinkOnScroll: true, iconSize: 20,
      showSearch: true, searchStyle: 'inline', showAccount: true, showWishlist: true, showCart: true, cartBadgeStyle: 'count',
      states: {
        normal: { backgroundColor: '#1e293b', textColor: '#f1f5f9', borderBottom: true, borderColor: '#334155', shadow: 'none', blur: false, height: 56 },
        sticky: { backgroundColor: '#0f172a', textColor: '#f1f5f9', borderBottom: true, borderColor: '#1e293b', shadow: 'medium', blur: false, height: 48 },
        transparent: { backgroundColor: 'transparent', textColor: '#ffffff', borderBottom: false, borderColor: 'transparent', shadow: 'none', blur: false, height: 56 },
      },
    },
  },
  {
    id: 'compact',
    name: 'Compact',
    tagline: 'Fino e discreto, sem distrações',
    tags: ['Micro', 'Funcional'],
    config: {
      layout: 'classic', menuStyle: 'horizontal', menuUppercase: true, menuFontWeight: 600,
      menuFontSize: 10, menuHoverStyle: 'underline', menuSeparator: 'dot', menuItemGap: 12,
      menuLetterSpacing: 0.15, headerSurface: false, borderBottom: true, shadowOnScroll: false,
      iconStrokeWidth: 1.5, height: 44, sticky: true, shrinkOnScroll: false, iconSize: 16,
      showSearch: true, searchStyle: 'modal', showAccount: false, showWishlist: false, showCart: true, cartBadgeStyle: 'dot',
      states: {
        normal: { backgroundColor: '#ffffff', textColor: '#374151', borderBottom: true, borderColor: '#e5e7eb', shadow: 'none', blur: false, height: 44 },
        sticky: { backgroundColor: '#ffffff', textColor: '#374151', borderBottom: true, borderColor: '#d1d5db', shadow: 'subtle', blur: true, height: 40 },
        transparent: { backgroundColor: 'transparent', textColor: '#ffffff', borderBottom: false, borderColor: 'transparent', shadow: 'none', blur: false, height: 44 },
      },
    },
  },
  {
    id: 'brutalist',
    name: 'Brutalist',
    tagline: 'Sem adornos, máximo contraste',
    tags: ['Raw', 'Direto'],
    config: {
  ...
  },
  {
    id: 'pastel-soft',
    name: 'Pastel',
    tagline: 'Suave, feminino, delicado',
    tags: ['Soft', 'Delicado'],
    config: {
      layout: 'centered', menuStyle: 'horizontal', menuUppercase: false, menuFontWeight: 400,
      menuFontSize: 13, menuHoverStyle: 'underline', menuSeparator: 'dot', menuItemGap: 24,
  ...
  },
  {
    id: 'navy-gold',
    name: 'Navy & Gold',
    tagline: 'Clássico premium, tom sério',
    tags: ['Premium', 'Clássico'],
    config: {
      layout: 'classic', menuStyle: 'dropdown', menuUppercase: true, menuFontWeight: 500,
      menuFontSize: 11, menuHoverStyle: 'underline', menuSeparator: 'none', menuItemGap: 24,
      menuLetterSpacing: 0.14, headerSurface: false, dropdownElevated: true, borderBottom: true,
      shadowOnScroll: true, iconStrokeWidth: 1.5, height: 64, sticky: true, shrinkOnScroll: true, iconSize: 18,
      showSearch: true, searchStyle: 'modal', showAccount: true, showWishlist: true, showCart: true, cartBadgeStyle: 'count',
      states: {
        normal: { backgroundColor: '#0c1a3a', textColor: '#d4a853', borderBottom: true, borderColor: '#1a2d5a', shadow: 'none', blur: false, height: 64 },
        sticky: { backgroundColor: '#091430', textColor: '#d4a853', borderBottom: true, borderColor: '#1a2d5a', shadow: 'medium', blur: false, height: 52 },
        transparent: { backgroundColor: 'transparent', textColor: '#d4a853', borderBottom: false, borderColor: 'transparent', shadow: 'none', blur: false, height: 64 },
      },
    },
  },
  {
    id: 'search-first',
    name: 'Search First',
    tagline: 'Busca como protagonista',
    tags: ['E-commerce', 'Catálogo'],
    config: {
      layout: 'double-row', menuStyle: 'mega-menu', menuUppercase: false, menuFontWeight: 500,
      menuFontSize: 14, menuHoverStyle: 'background', menuSeparator: 'none', menuItemGap: 8,
      headerSurface: true, dropdownElevated: true, borderBottom: true, shadowOnScroll: true,
      iconStrokeWidth: 1.5, height: 60, sticky: true, shrinkOnScroll: true, iconSize: 20,
      showSearch: true, searchStyle: 'inline', showAccount: true, showWishlist: true, showCart: true, cartBadgeStyle: 'count',
      states: {
        normal: { backgroundColor: '#ffffff', textColor: '#1a1a1a', borderBottom: true, borderColor: '#e5e7eb', shadow: 'subtle', blur: false, height: 60 },
        sticky: { backgroundColor: '#f9fafb', textColor: '#1a1a1a', borderBottom: true, borderColor: '#e5e7eb', shadow: 'medium', blur: true, height: 52 },
        transparent: { backgroundColor: 'transparent', textColor: '#ffffff', borderBottom: false, borderColor: 'transparent', shadow: 'none', blur: false, height: 60 },
      },
    },
  },
  {
    id: 'hamburger-clean',
    name: 'Hamburger',
    tagline: 'Logo + ícones, menu no drawer',
    tags: ['Mobile-first', 'Clean'],
    config: {
      layout: 'hamburger-only', menuStyle: 'horizontal', menuUppercase: false, menuFontWeight: 500,
      menuFontSize: 13, menuHoverStyle: 'underline', menuSeparator: 'none', menuItemGap: 16,
      headerSurface: false, borderBottom: true, shadowOnScroll: false, iconStrokeWidth: 1.5,
      height: 56, sticky: true, shrinkOnScroll: false, iconSize: 20,
      showSearch: true, searchStyle: 'modal', showAccount: true, showWishlist: false, showCart: true, cartBadgeStyle: 'count',
  ...
  },
  {
    ...
    config: {
      ...
      showSearch: true, searchStyle: 'modal', showAccount: true, showWishlist: false, showCart: true, cartBadgeStyle: 'count',
      states: {
        normal: { backgroundColor: '#1a2f23', textColor: '#d4e7d6', borderBottom: true, borderColor: '#2a4a33', shadow: 'none', blur: false, height: 60 },
        sticky: { backgroundColor: '#142a1d', textColor: '#d4e7d6', borderBottom: true, borderColor: '#2a4a33', shadow: 'subtle', blur: false, height: 52 },
        transparent: { backgroundColor: 'transparent', textColor: '#ffffff', borderBottom: false, borderColor: 'transparent', shadow: 'none', blur: false, height: 60 },
      },
    },
  },
  {
    id: 'gradient-aurora',
    name: 'Aurora',
    tagline: 'Gradiente sutil e refinado',
    tags: ['Gradiente', 'Inovador'],
    config: {
      layout: 'centered', menuStyle: 'horizontal', menuUppercase: true, menuFontWeight: 500,
      menuFontSize: 11, menuHoverStyle: 'underline', menuSeparator: 'none', menuItemGap: 28,
      menuLetterSpacing: 0.1, headerSurface: false, borderBottom: false, shadowOnScroll: false,
      iconStrokeWidth: 1.5, height: 68, sticky: true, shrinkOnScroll: true, iconSize: 18,
      showSearch: true, searchStyle: 'modal', showAccount: true, showWishlist: true, showCart: true, cartBadgeStyle: 'dot',
      states: {
        normal: { backgroundColor: '#1e1b4b', textColor: '#e0e7ff', borderBottom: false, borderColor: 'transparent', shadow: 'none', blur: false, height: 68 },
        sticky: { backgroundColor: '#1e1b4b', textColor: '#e0e7ff', borderBottom: true, borderColor: '#312e81', shadow: 'medium', blur: true, height: 52 },
        transparent: { backgroundColor: 'transparent', textColor: '#ffffff', borderBottom: false, borderColor: 'transparent', shadow: 'none', blur: false, height: 68 },
      },
    },
  },
