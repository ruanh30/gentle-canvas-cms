...
export const mockProducts: Product[] = [
  ...
  },
  {
    ...
    variants: [
      { id: 'v8', productId: 'prod-3', name: 'P', sku: 'VES-001-P', price: 249.90, stock: 15, attributes: { tamanho: 'P' } },
      { id: 'v9', productId: 'prod-3', name: 'M', sku: 'VES-001-M', price: 249.90, stock: 15, attributes: { tamanho: 'M' } },
      { id: 'v10', productId: 'prod-3', name: 'G', sku: 'VES-001-G', price: 249.90, stock: 15, attributes: { tamanho: 'G' } },
    ],
  },
  {
