...
class BasicController extends Controller
{
    ...
    public function updateThemeVersion(Request $request)
    {
        ...
        $data->theme = in_array($request->input('theme'), ['premium']) ? $request->input('theme') : 'premium';
        $data->save();
                ...
                function ($attribute, $value, $fail) use ($img, $allowedExts) {
                    if (!empty($img)) {
                        ...
                        if (!in_array($ext, $allowedExts)) {
                            return $fail(__("Only GIF, JPG, JPEG, PNG, SVG file formats are allowed"));
                        }
                    }
                },
            ],
    ...
    public function updateInfo(Request $request)
    {
        ...
        $allowedExts = array('jpg', 'jpeg', 'png', 'gif', 'svg');
