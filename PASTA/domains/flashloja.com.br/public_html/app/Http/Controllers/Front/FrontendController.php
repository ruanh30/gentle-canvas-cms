...
class FrontendController extends Controller
{
    ...
    {
        // Same data as the current homepage, but rendered with an alternate template
        if (session()->has('lang')) {
            $currentLang = Language::where('code', session()->get('lang'))->first();
        } else {
            $currentLang = Language::where('is_default', 1)->first();
        ...
        $data['partners'] = Partner::orderBy('serial_number', 'ASC')->get();
        ...
        return view('front.preview-home', $data);
    }

    private function buildHomePreviewData()
    {
        if (session()->has('lang')) {
            $currentLang = Language::where('code', session()->get('lang'))->first();
        } else {
    ...
    public function previewHome1() { $data = $this->buildHomePreviewData(); return view('front.preview-home-1', $data); }
    public function previewHome2() { $data = $this->buildHomePreviewData(); return view('front.preview-home-2', $data); }
    public function previewHome3() { $data = $this->buildHomePreviewData(); return view('front.preview-home-3', $data); }
    public function previewHome4() { $data = $this->buildHomePreviewData(); return view('front.preview-home-4', $data); }
    public function previewHome5() { $data = $this->buildHomePreviewData(); return view('front.preview-home-5', $data); }
    ...
    public function previewHomePlus1() { $data = $this->buildHomePreviewData(); return view('front.preview-home-plus-1', $data); }
    public function previewHomePlus2() { $data = $this->buildHomePreviewData(); return view('front.preview-home-plus-2', $data); }
    public function previewHomePlus3() { $data = $this->buildHomePreviewData(); return view('front.preview-home-plus-3', $data); }
    public function previewHomePlus4() { $data = $this->buildHomePreviewData(); return view('front.preview-home-plus-4', $data); }
    public function previewHomePlus5() { $data = $this->buildHomePreviewData(); return view('front.preview-home-plus-5', $data); }

    public function previewNovo1() { $data = $this->buildHomePreviewData(); return view('front.preview-novo-1', $data); }
    public function previewNovo2() { $data = $this->buildHomePreviewData(); return view('front.preview-novo-2', $data); }
    public function previewNovo3() { $data = $this->buildHomePreviewData(); return view('front.preview-novo-3', $data); }
    public function previewNovo4() { $data = $this->buildHomePreviewData(); return view('front.preview-novo-4', $data); }
    public function previewNovo5() { $data = $this->buildHomePreviewData(); return view('front.preview-novo-5', $data); }

    public function previewLojaFlash(Request $request)
    {
        $data = $this->buildHomePreviewData();

        // pricing data (reuse existing logic)
        $data['bex'] = BE::first();
        $data['abs'] = BS::first();
        $data['be'] = BasicExtended::first();
        ...
        return view('front.preview-lojaflash', $data);
    }
}
