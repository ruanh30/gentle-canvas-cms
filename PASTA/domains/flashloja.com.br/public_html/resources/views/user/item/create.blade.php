          ...
          <div class="row">
            <div class="col-lg-9 m-auto">
              ...
              <div class="px-2">
                ...
                <form action="{{ '#' }}" id="my-dropzone" enctype="multipart/form-data"
                ...
                <p class="text-muted" style="font-size:13px;">{{ __('Opcional: se não quiser usar o slider de imagens, deixe este campo vazio.') }}</p>
                ...
                <div class="row">
                  ...
                  <div class="col-lg-4">
                    <div class="form-group {{ $lang->rtl == 1 ? 'rtl text-right' : '' }}">
                      ...
                      <select data-code="{{ $lang->code }}" name="category" class="form-control">
...
@section('scripts')
  <script>
    ...
    const rmvSliderImage = "{{ route('user.item.sliderRemove') }}";
    const rmvDbSliderImage = "{{ route('user.item.dbSliderRemove') }}";
  </script>
  @php
