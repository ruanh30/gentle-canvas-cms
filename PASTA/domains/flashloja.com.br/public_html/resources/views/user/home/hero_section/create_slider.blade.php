              ...
              <form id="sliderVersionForm" action="{{ route('user.home_page.hero.store_slider_info') }}" method="POST"
                ...
                <div class="form-group">
                  ...
                  <select name="banner_size" class="form-control">
                    <option value="870x590" {{ (old('banner_size') ?? '870x590') == '870x590' ? 'selected' : '' }}>870x590</option>
                    <option value="1900x600" {{ (old('banner_size') ?? '870x590') == '1900x600' ? 'selected' : '' }}>1900x600</option>
                    <option value="1900x450" {{ (old('banner_size') ?? '870x590') == '1900x450' ? 'selected' : '' }}>1900x450</option>
                  </select>
                ...
                <div class="form-group">
                  ...
                  <div class="custom-control custom-checkbox">
                    <input type="checkbox" class="custom-control-input" id="fillEdges" name="fill_edges" value="1">
