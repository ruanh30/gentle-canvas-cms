...
@section('content')
  ...
  @else
    <div class="row justify-content-center align-items-center mb-1">
      <div class="col-12">
        <div class="alert border-left border-primary text-dark fl-package-banner" style="background:#E9F1F7 !important;background-color:#E9F1F7 !important;border:1px solid #c6ddef !important;border-left:1px solid #c6ddef !important;">
          @if ($package_count >= 2)
  ...
  <div class="row">
    @if (!is_null($package))
      <div class="col-sm-6 col-md-4">
        <a class="card card-stats glass-card fl-kpi-card card-primary card-round"
      ...
      <div class="col-sm-6 col-md-4">
        <a class="card card-stats glass-card fl-kpi-card card-secondary card-round" href="{{ route('user.all.item.orders') }}">
          <div class="card-body">
            <div class="row">
              <div class="col-5">
                <div class="icon-big text-center">
      ...
      <div class="col-sm-6 col-md-4">
        <a class="card card-stats glass-card fl-kpi-card card-info card-round" href="{{ route('user.register.user') }}">
          <div class="card-body">
            <div class="row">
              <div class="col-5">
                <div class="icon-big text-center">
      ...
      <div class="col-sm-6 col-md-4">
        <a class="card card-stats glass-card fl-kpi-card card-warning card-round" href="{{ route('user.subscriber.index') }}">
          <div class="card-body">
            <div class="row">
              <div class="col-5">
                <div class="icon-big text-center">
    ...
    @if (!empty($permissions) && in_array('Blog', $permissions))
      <div class="col-sm-6 col-md-4">
        <a class="card card-stats glass-card fl-kpi-card card-success card-round" href="{{ route('user-dashboard') }}">
          <div class="card-body">
            <div class="row">
              <div class="col-5">
                <div class="icon-big text-center">
    ...
    @if (!empty($permissions) && in_array('Custom Page', $permissions))
      <div class="col-sm-6 col-md-4">
        <a class="card card-stats glass-card fl-kpi-card card-danger card-round" href="{{ route('user-dashboard') }}">
          <div class="card-body">
            <div class="row">
              <div class="col-5">
                <div class="icon-big text-center">
          ...
          <div class="card">
            ...
            <div class="card-body">
              <div class="row">
                <div class="col-lg-12">
                  @if (count($orders) == 0)
                    <p class="empty-text text-center">{{ __('NO PRODUCT ORDER FOUND') }}</p>
                  @else
