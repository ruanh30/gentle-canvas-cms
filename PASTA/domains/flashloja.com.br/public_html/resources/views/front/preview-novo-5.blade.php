...
<style>
  ...
  .lp-hero{background: radial-gradient(900px 520px at 15% 20%, rgba(109,40,217,.18), transparent 60%), radial-gradient(900px 520px at 85% 30%, rgba(37,99,235,.14), transparent 55%), linear-gradient(180deg, rgba(2,6,23,.02), rgba(2,6,23,0));}
  .lp-card{border-radius: 18px;}
  .lp-btn-primary{background: linear-gradient(90deg, #6d28d9, #2563eb); border:0;}
...
<div class="lp-kicker">Landing tecnologica (sem perder seriedade)</div>
