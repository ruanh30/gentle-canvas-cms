...
<body>
  ...
  @if (!request()->routeIs('front.index') && !request()->routeIs('front.preview_home') && !request()->routeIs('front.preview_home_1') && !request()->routeIs('front.preview_home_2') && !request()->routeIs('front.preview_home_3') && !request()->routeIs('front.preview_home_4') && !request()->routeIs('front.preview_home_5' && !request()->routeIs('front.preview_home_plus_1') && !request()->routeIs('front.preview_home_plus_2') && !request()->routeIs('front.preview_home_plus_3') && !request()->routeIs('front.preview_home_plus_4') && !request()->routeIs('front.preview_home_plus_5' && !request()->routeIs('front.preview_novo_1') && !request()->routeIs('front.preview_novo_2') && !request()->routeIs('front.preview_novo_3') && !request()->routeIs('front.preview_novo_4') && !request()->routeIs('front.preview_novo_5'))))
    <!-- Page Title Start-->
