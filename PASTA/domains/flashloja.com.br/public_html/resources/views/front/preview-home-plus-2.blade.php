...
<style>
  ...
  :root{--ph-accent:#1d4ed8;} .ph-hero{background:radial-gradient(900px 520px at 15% 20%, rgba(29,78,216,.18), transparent 60%), radial-gradient(900px 520px at 85% 30%, rgba(29,78,216,.10), transparent 55%), linear-gradient(180deg, rgba(2,6,23,.02), rgba(2,6,23,0));}
</style>
@endsection
...
<div class="ph-wrap">
  <div class="ph-top">
    <div class="container d-flex flex-wrap align-items-center justify-content-between" style="gap:10px;">
      <div>Modelo Plus 2/5: corporate blue (mais clean, mais produto).</div>
    ...
    <div class="container">
      <div class="row align-items-center">
        ...
        <div class="col-lg-6 mt-4 mt-lg-0">
          <div class="ph-heroimg"><img src="https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?auto=format&fit=crop&w=1600&q=80" alt="Hero" /></div>
        </div>
      </div>
  ...
  <section class="ph-section"><div class="container"><div class="row mb-4"><div class="col-lg-8"><h2 class="ph-h2">Produto em destaque</h2><p class="ph-lead">Mais ênfase em "o que eu ganho" e menos em texto longo.</p></div></div><div class="row g-3"><div class="col-md-6 col-lg-3"><div class="ph-card"><div class="ph-gridicon">1</div><h3>Templates</h3><div class="ph-muted">Escolha um visual e publique.</div></div></div><div class="col-md-6 col-lg-3"><div class="ph-card"><div class="ph-gridicon">2</div><h3>Pagamentos</h3><div class="ph-muted">Ative métodos e receba.</div></div></div><div class="col-md-6 col-lg-3"><div class="ph-card"><div class="ph-gridicon">3</div><h3>Pedidos</h3><div class="ph-muted">Processo do pedido ao envio.</div></div></div><div class="col-md-6 col-lg-3"><div class="ph-card"><div class="ph-gridicon">4</div><h3>Escala</h3><div class="ph-muted">Estrutura para crescer.</div></div></div></div></div></section>
