...
<style>
  ...
  :root{--ph-accent:#4f46e5;} .ph-btn-primary{background:linear-gradient(90deg,#7c3aed,#4f46e5);border:0;} .ph-hero{background:radial-gradient(900px 520px at 15% 20%, rgba(124,58,237,.20), transparent 60%), radial-gradient(900px 520px at 85% 30%, rgba(79,70,229,.14), transparent 55%), linear-gradient(180deg, rgba(2,6,23,.02), rgba(2,6,23,0));}
</style>
@endsection
...
<div class="ph-wrap">
  <div class="ph-top">
    <div class="container d-flex flex-wrap align-items-center justify-content-between" style="gap:10px;">
      <div>Modelo Plus 5/5: tecnologico premium (sem perder seriedade).</div>
    ...
    <div class="container">
      <div class="row align-items-center">
        ...
        <div class="col-lg-6 mt-4 mt-lg-0">
          <div class="ph-heroimg"><img src="https://images.unsplash.com/photo-1519389950473-47ba0277781c?auto=format&fit=crop&w=1600&q=80" alt="Hero" /></div>
        </div>
      </div>
  ...
  <section class="ph-section ph-surface"><div class="container"><div class="row mb-4"><div class="col-lg-8"><h2 class="ph-h2">Design de produto</h2><p class="ph-lead">Energia de tech company: destaque no botão, seções curtas e visual limpo.</p></div></div><div class="row g-3"><div class="col-md-6 col-lg-4"><div class="ph-card"><h3>Performance</h3><div class="ph-muted">Velocidade e responsividade.</div></div></div><div class="col-md-6 col-lg-4"><div class="ph-card"><h3>Automacao</h3><div class="ph-muted">Rotinas e integrações (simulado).</div></div></div><div class="col-md-6 col-lg-4"><div class="ph-card"><h3>Brand</h3><div class="ph-muted">Padrão visual consistente.</div></div></div></div></div></section>
