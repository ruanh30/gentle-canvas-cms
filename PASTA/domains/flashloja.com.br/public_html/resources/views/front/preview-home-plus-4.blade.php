...
<style>
  ...
  :root{--ph-accent:#111827;} .ph-hero{background:linear-gradient(180deg,rgba(17,24,39,.06),rgba(17,24,39,0));}
</style>
@endsection
...
<div class="ph-wrap">
  <div class="ph-top">
    <div class="container d-flex flex-wrap align-items-center justify-content-between" style="gap:10px;">
      <div>Modelo Plus 4/5: ultra sobrio (grafite) com linguagem enterprise.</div>
    ...
    <div class="container">
      <div class="row align-items-center">
        ...
        <div class="col-lg-6 mt-4 mt-lg-0">
          <div class="ph-heroimg"><img src="https://images.unsplash.com/photo-1518770660439-4636190af475?auto=format&fit=crop&w=1600&q=80" alt="Hero" /></div>
        </div>
      </div>
  ...
  <section class="ph-section"><div class="container"><div class="row mb-4"><div class="col-lg-8"><h2 class="ph-h2">Governança e padrão</h2><p class="ph-lead">Texto mais "B2B": foco em processo, consistência e confiabilidade.</p></div></div><div class="row g-3 ph-faq"><div class="col-lg-6"><details><summary>Como evitamos um site "bonito que quebra"?</summary><p>Separando layout (CSS) de regras do sistema, com preview e rollback.</p></details></div><div class="col-lg-6"><details><summary>O que muda primeiro?</summary><p>Hero, CTA, prova social e seções essenciais. O resto vem depois.</p></details></div></div></div></section>
