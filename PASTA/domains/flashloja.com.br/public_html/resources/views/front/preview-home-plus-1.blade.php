...
<style>
  ...
  :root{--ph-accent:#0b1220;} .ph-btn-primary{box-shadow:0 18px 60px rgba(2,6,23,.18);} 
</style>
@endsection
...
<div class="ph-wrap">
  <div class="ph-top">
    <div class="container d-flex flex-wrap align-items-center justify-content-between" style="gap:10px;">
      <div>Modelo Plus 1/5: corporativo premium (navy + branco).</div>
  ...
  <section class="ph-section ph-surface"><div class="container"><div class="row mb-4"><div class="col-lg-8"><h2 class="ph-h2">Seções no formato enterprise</h2><p class="ph-lead">Alternância texto + imagem, sem enfeite desnecessário.</p></div></div><div class="row g-3"><div class="col-lg-6"><div class="ph-card"><h3>Segurança e confiabilidade</h3><div class="ph-muted">Boas práticas de checkout e experiência sem ruído.</div></div></div><div class="col-lg-6"><div class="ph-heroimg"><img src="https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&w=1600&q=80" alt=""/></div></div></div></div></section>
