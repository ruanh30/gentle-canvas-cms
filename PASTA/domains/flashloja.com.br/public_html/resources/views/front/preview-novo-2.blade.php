...
<style>
  ...
  .lp-title{letter-spacing:-.04em;}
  .lp-media{transform: perspective(1200px) rotateX(2deg);}
  .lp-final{background: radial-gradient(900px 520px at 50% 0%, rgba(124,58,237,.14), transparent 55%);}
...
<div class="lp">
  <section class="lp-hero">
    <div class="container">
      <div class="row justify-content-center"><div class="col-lg-9 text-center"><div class="">
<div class="lp-kicker">Landing clean centrada (mais "Apple")</div>
