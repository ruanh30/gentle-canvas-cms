...
<style>
  ...
  .lp-hero{background: radial-gradient(900px 520px at 15% 20%, rgba(37,99,235,.18), transparent 60%), radial-gradient(900px 520px at 85% 30%, rgba(124,58,237,.14), transparent 55%), linear-gradient(180deg, rgba(2,6,23,.02), rgba(2,6,23,0));}
  .lp-kicker{background: rgba(124,58,237,.08); border-color: rgba(124,58,237,.16);}
...
<div class="lp-kicker">Landing premium (azul e roxo)</div>
