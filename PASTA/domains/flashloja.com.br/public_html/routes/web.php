...
Route::domain($domain)->group(function () {
    ...
    Route::group(['middleware' => 'setlang'], function () {
        ...
        Route::get('/preview-home', 'Front\FrontendController@previewHome')->name('front.preview_home');
        Route::get('/preview-lojaflash', 'Front\FrontendController@previewLojaFlash')->name('front.preview_lojaflash');
        Route::get('/preview-novo-1', 'Front\FrontendController@previewNovo1')->name('front.preview_novo_1');
        Route::get('/preview-novo-2', 'Front\FrontendController@previewNovo2')->name('front.preview_novo_2');
        Route::get('/preview-novo-3', 'Front\FrontendController@previewNovo3')->name('front.preview_novo_3');
        Route::get('/preview-novo-4', 'Front\FrontendController@previewNovo4')->name('front.preview_novo_4');
        Route::get('/preview-novo-5', 'Front\FrontendController@previewNovo5')->name('front.preview_novo_5');
        Route::get('/preview-home-plus-1', 'Front\FrontendController@previewHomePlus1')->name('front.preview_home_plus_1');
        Route::get('/preview-home-plus-2', 'Front\FrontendController@previewHomePlus2')->name('front.preview_home_plus_2');
        Route::get('/preview-home-plus-3', 'Front\FrontendController@previewHomePlus3')->name('front.preview_home_plus_3');
        Route::get('/preview-home-plus-4', 'Front\FrontendController@previewHomePlus4')->name('front.preview_home_plus_4');
        Route::get('/preview-home-plus-5', 'Front\FrontendController@previewHomePlus5')->name('front.preview_home_plus_5');
        Route::get('/preview-home-1', 'Front\FrontendController@previewHome1')->name('front.preview_home_1');
        Route::get('/preview-home-2', 'Front\FrontendController@previewHome2')->name('front.preview_home_2');
        Route::get('/preview-home-3', 'Front\FrontendController@previewHome3')->name('front.preview_home_3');
        Route::get('/preview-home-4', 'Front\FrontendController@previewHome4')->name('front.preview_home_4');
        Route::get('/preview-home-5', 'Front\FrontendController@previewHome5')->name('front.preview_home_5');
