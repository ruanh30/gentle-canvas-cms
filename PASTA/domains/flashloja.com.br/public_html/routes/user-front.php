...
Route::group(['domain' => $domain, 'prefix' => $prefix, 'middleware' => ['userVisibilityCheck', 'userLanguage', 'userMaintenance']], function () {
    Route::get('/', 'UserFront\ThemeStorefrontController@home')
    ...
    Route::get('/shop', 'UserFront\ThemeStorefrontController@products')->name('front.user.shop');
    ...
    Route::get('/product/{slug}', 'UserFront\ThemeStorefrontController@productDetail')->name('front.user.productDetails');
    ...
    Route::get('/cart', 'UserFront\ThemeStorefrontController@cart')->name('front.user.cart');
    ...
    Route::prefix('/customer')->middleware(['auth:customer', 'accountStatus', 'checkWebsiteOwner', 'Demo'])->group(function () {
        ...
        Route::get('/checkout', 'UserFront\ThemeStorefrontController@checkout')->name('front.user.checkout.final_step');
