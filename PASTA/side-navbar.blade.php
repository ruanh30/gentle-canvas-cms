  ...
  <div class="sidebar-wrapper scrollbar scrollbar-inner">
    <div class="sidebar-content">
      ...
      <ul class="nav nav-primary">
        ...
        @if (true)
        {{-- ═══════════════════ LOJA ═══════════════════ --}}
        <li class="fl-section-label">LOJA</li>
        ...
        {{-- Products --}}
        <li class="nav-item
          @if (request()->routeIs('user.item.index')) active
          ...
          <a data-toggle="collapse" href="#flProducts">
            <i class="fas fa-box"></i>
            <p>{{ __('Products') }}</p>
            <span class="caret"></span>
          </a>
          <div class="collapse
            @if (request()->routeIs('user.item.index')) show
            ...
            id="flProducts">
            <ul class="nav nav-collapse">
              <li class="@if (request()->routeIs('user.item.index')) active @elseif(request()->routeIs('user.item.edit')) active @elseif(request()->routeIs('user.item.variations')) active @endif">
                <a href="{{ route('user.item.index') . '?language=' . $defaultLang }}"><span class="sub-item">{{ __('Items') }}</span></a>
              </li>
              <li class="@if (request()->routeIs('user.item.type')) active @elseif(request()->routeIs('user.item.create')) active @endif">
                <a href="{{ route('user.item.type') }}"><span class="sub-item">{{ __('Add Item') }}</span></a>
              </li>
              <li class="@if (request()->routeIs('user.variant.index')) active @elseif(request()->routeIs('user.variant.edit')) active @endif">
                <a href="{{ route('user.variant.index') . '?language=' . $defaultLang }}"><span class="sub-item">{{ __('Variations') }}</span></a>
              </li>
              <li class="@if (request()->routeIs('user.variant.create')) active @endif">
                <a href="{{ route('user.variant.create') . '?language=' . $defaultLang }}"><span class="sub-item">{{ __('Add Variant') }}</span></a>
              </li>
            </ul>
          </div>
        </li>
        ...
        <li class="nav-item
          ...
          @elseif(request()->routeIs('user.category.variations')) active @endif">
        ...
        {{-- Subcategories --}}
        <li class="nav-item
          @if (request()->routeIs('user.itemsubcategory.index')) active
          @elseif(request()->routeIs('user.itemsubcategory.edit')) active
          @elseif(request()->routeIs('user.subcategory.variations')) active @endif">
        ...
        {{-- Labels --}}
        <li class="nav-item @if (request()->routeIs('user.product.label.index')) active @endif">
        ...
        {{-- ═══════════════════ CONFIGURAÇÕES ═══════════════════ --}}
        <li class="fl-section-label">CONFIGURAÇÕES</li>
        ...
        <li class="nav-item
          ...
          @elseif(request()->routeIs('user.language.editKeyword')) active
          @elseif(request()->routeIs('user.gateway.index')) active
          @elseif(request()->routeIs('user.gateway.offline')) active
          @elseif(request()->routeIs('user.appearance')) active
          @elseif(request()->routeIs('user.menu_builder.index')) active @endif">
          ...
          <div class="collapse
            ...
            @elseif(request()->routeIs('user.appearance')) show
            @elseif(request()->routeIs('user.menu_builder.index')) show @endif"
            id="flSiteSettings">
            <ul class="nav nav-collapse">
              <li class="@if (request()->routeIs('user.appearance')) active @endif">
                <a href="{{ route('user.appearance') }}"><span class="sub-item">{{ __('Aparência') }}</span></a>
              </li>
              @if(true)
              <li class="@if (request()->routeIs('user.basic_settings.general-settings')) active @endif">
                <a href="{{ route('user.basic_settings.general-settings') }}"><span class="sub-item">{{ __('General Settings') }}</span></a>
              </li>
              @endif
              @if(true)
              <li class="@if (request()->routeIs('user.theme.version')) active @endif">
                <a href="{{ route('user.theme.version') }}"><span class="sub-item">{{ __('Themes') }}</span></a>
              </li>
              @endif
              @if(true)
              ...
              <li class="@if (request()->routeIs('user.social.edit')) active @elseif(request()->routeIs('user.social.index')) active @endif">
                <a href="{{ route('user.social.index') }}"><span class="sub-item">{{ __('Social Links') }}</span></a>
              </li>
              @if(true)
              ...
              @if(true)
              <li class="@if (request()->routeIs('user.language.index')) active @elseif(request()->routeIs('user.language.edit')) active @elseif(request()->routeIs('user.language.editKeyword')) active @endif">
                <a href="{{ route('user.language.index') }}"><span class="sub-item">{{ __('Languages') }}</span></a>
              </li>
              @endif
              @if (true)
              ...
              <li class="submenu @if (request()->routeIs('user-domains')) selected @elseif(request()->routeIs('user-subdomain')) selected @endif">
                ...
                <div class="collapse @if (request()->routeIs('user-domains')) show @elseif(request()->routeIs('user-subdomain')) show @endif" id="domains">
                  <ul class="nav nav-collapse subnav">
                    ...
                    @else
                    <li class="@if (request()->routeIs('user-subdomain')) active @endif">
                      <a href="{{ route('user-subdomain') }}"><span class="sub-item">{{ __('Path Based URL') }}</span></a>
                    </li>
                    @endif
                  </ul>
                </div>
              ...
              <li class="@if (request()->routeIs('user.menu_builder.index')) active @endif">
                <a href="{{ route('user.menu_builder.index') . '?language=' . $defaultLang }}"><span class="sub-item">{{ __('Menu Builder') }}</span></a>
              </li>
            </ul>
          </div>
        </li>
        ...
        <li class="nav-item
          ...
          <a data-toggle="collapse" href="#flPages">
            ...
            <ul class="nav nav-collapse">
              ...
              <li class="submenu
                ...
                <div class="collapse
                  ...
                  id="homepage">
                  <ul class="nav nav-collapse subnav">
                    <li class="@if (request()->routeIs('user.image_text_content.section')) active @endif">
                      <a href="{{ route('user.image_text_content.section', ['language' => $defaultLang]) }}"><span class="sub-item">{{ __('Images & Texts') }}</span></a>
                    </li>
                    @php $__allow_hero_section = ['pet', 'jewellery']; @endphp
                    @if (in_array($userBs->theme, $__allow_hero_section))
                      <li class="@if (request()->routeIs('user.home_page.static_hero_section')) active @endif">
                        <a href="{{ route('user.home_page.static_hero_section', ['language' => $defaultLang]) }}"><span class="sub-item">{{ __('Hero Section') }}</span></a>
                      </li>
                    @else
                      <li class="submenu">
                        <a data-toggle="collapse" href="#hero-section"
                          aria-expanded="{{ request()->routeIs('user.home_page.hero.create_slider') || request()->routeIs('user.home_page.heroSec.product_slider') || request()->routeIs('user.home_page.hero.slider_version') || request()->routeIs('user.home_page.herosec.bacground_img') || request()->routeIs('user.home_page.hero.edit_slider') ? 'true' : 'false' }}">
                          <span class="sub-item">{{ __('Hero Section') }}</span>
                          <span class="caret"></span>
                        </a>
                        <div id="hero-section" class="collapse @if (request()->routeIs('user.home_page.hero.slider_version') || request()->routeIs('user.home_page.heroSec.product_slider') || request()->routeIs('user.home_page.herosec.bacground_img') || request()->routeIs('user.home_page.hero.create_slider') || request()->routeIs('user.home_page.hero.edit_slider')) show @endif pl-3">
                          <ul class="nav nav-collapse subnav">
                            @if ($userBs->theme == 'fashion')
                              <li class="{{ request()->routeIs('user.home_page.heroSec.product_slider') ? 'active' : '' }}">
                                <a href="{{ route('user.home_page.heroSec.product_slider') }}"><span class="sub-item">{{ __('Sliders') }}</span></a>
                              </li>
                            @else
                              <li class="@if (request()->routeIs('user.home_page.hero.slider_version')) active @elseif (request()->routeIs('user.home_page.hero.create_slider')) active @elseif (request()->routeIs('user.home_page.hero.edit_slider')) active @endif">
                                <a href="{{ route('user.home_page.hero.slider_version', ['language' => $defaultLang]) }}"><span class="sub-item">{{ __('Sliders') }}</span></a>
                              </li>
                            @endif
                            @if ($userBs->theme == 'kids' || $userBs->theme == 'furniture' || $userBs->theme == 'fashion')
                              <li class="@if (request()->routeIs('user.home_page.herosec.bacground_img')) active @endif">
                                <a href="{{ route('user.home_page.herosec.bacground_img', ['language' => $defaultLang, getParam()]) }}"><span class="sub-item">{{ __('Background Image') }}</span></a>
                              </li>
                            @endif
                          </ul>
                        </div>
                    ...
                    @endif
                    @php $allow_features_menus = ['vegetables', 'fashion', 'electronics', 'manti', 'pet', 'skinflow', 'jewellery']; @endphp
                    @if (in_array($userBs->theme, $allow_features_menus))
                      <li class="@if (request()->routeIs('user.home_page.heroSec.how_it_work')) active @endif">
                        <a href="{{ route('user.home_page.heroSec.how_it_work', ['language' => $defaultLang]) }}"><span class="sub-item">{{ __('Features') }}</span></a>
                      </li>
                    @endif
                    <li class="@if (request()->routeIs('user.home_page.banner_section')) active @endif">
                      <a href="{{ route('user.home_page.banner_section', ['language' => $defaultLang]) }}"><span class="sub-item">{{ __('Banners') }}</span></a>
                    </li>
                    <li class="@if (request()->routeIs('user.tab.index')) active @elseif (request()->routeIs('user.tab.edit')) active @elseif (request()->routeIs('user.tab.feature')) active @elseif (request()->routeIs('user.tab.products')) active @endif">
                      <a href="{{ route('user.tab.index', ['language' => $defaultLang]) }}">
                        @php $is_section = ['manti', 'pet', 'skinflow', 'jewellery']; @endphp
                        <span class="sub-item">{{ in_array($userBs->theme, $is_section) ? __('Product Sections') : __('Tabs') }}</span>
                      </a>
                    </li>
                    <li class="submenu">
                      <a data-toggle="collapse" href="#hoem-addi-section"
                        aria-expanded="{{ request()->routeIs('user.additional_sections') || request()->routeIs('user.additional_section.create') || request()->routeIs('user.additional_section.edit') ? 'true' : 'false' }}">
                        <span class="sub-item">{{ __('Additional Sections') }}</span>
                        <span class="caret"></span>
                      </a>
                      <div id="hoem-addi-section" class="collapse @if (request()->routeIs('user.additional_sections') || request()->routeIs('user.additional_section.create') || request()->routeIs('user.additional_section.edit')) show @endif pl-3">
                        <ul class="nav nav-collapse subnav">
                          <li class="{{ request()->routeIs('user.additional_section.create') ? 'active' : '' }}">
                            <a href="{{ route('user.additional_section.create') }}"><span class="sub-item">{{ __('Add Section') }}</span></a>
                          </li>
                          <li class="{{ request()->routeIs('user.additional_sections') || request()->routeIs('user.additional_section.edit') ? 'active' : '' }}">
                            <a href="{{ route('user.additional_sections', ['language' => $defaultLang]) }}"><span class="sub-item">{{ __('Sections') }}</span></a>
                          </li>
                        </ul>
                      </div>
                    </li>
                    <li class="@if (request()->routeIs('user.sections.index')) active @endif">
                      <a href="{{ route('user.sections.index') }}"><span class="sub-item">{{ __('Section Hide/Show') }}</span></a>
                    </li>
                    <li class="@if (request()->routeIs('user.sections.item_highlight')) active @endif">
                      <a href="{{ route('user.sections.item_highlight') }}"><span class="sub-item">{{ __('Item Highlights') }}</span></a>
                    </li>
                  </ul>
                </div>
              </li>
              ...
              <li class="submenu
                ...
                @elseif (request()->routeIs('user.pages.about_us.features.edit')) selected
                ...
                <div class="collapse
                  ...
                  <ul class="nav nav-collapse subnav">
                    @if ($userBs->theme == 'furniture' || $userBs->theme == 'kids')
                      <li class="@if (request()->routeIs('user.pages.about_us.features.index')) active @endif">
                        <a href="{{ route('user.pages.about_us.features.index', ['language' => $defaultLang]) }}"><span class="sub-item">{{ __('Features') }}</span></a>
                      </li>
                    @endif
                    <li class="@if (request()->routeIs('user.pages.aboutus.about')) active @elseif (request()->routeIs('user.pages.about_us.features.edit')) active @endif">
                      <a href="{{ route('user.pages.aboutus.about', ['language' => $defaultLang]) }}"><span class="sub-item">{{ __('About') }}</span></a>
                    </li>
                    <li class="@if (request()->routeIs('user.pages.counter_section.index')) active @elseif (request()->routeIs('user.pages.counter_section.counter.edit')) active @endif">
                      <a href="{{ route('user.pages.counter_section.index', ['language' => $defaultLang]) }}"><span class="sub-item">{{ __('Counter Section') }}</span></a>
                    </li>
                    <li class="@if (request()->routeIs('user.about_us.testimonial.index')) active @elseif (request()->routeIs('user.about_us.testimonial.edit')) active @endif">
                      <a href="{{ route('user.about_us.testimonial.index', ['language' => $defaultLang]) }}"><span class="sub-item">{{ __('Testimonials') }}</span></a>
                    </li>
                    <li class="submenu">
                      <a data-toggle="collapse" href="#about-additional-section"
                        aria-expanded="{{ request()->routeIs('user.about.additional_sections') || request()->routeIs('user.about.additional_section.create') || request()->routeIs('user.about.additional_section.edit') ? 'true' : 'false' }}">
                        <span class="sub-item">{{ __('Additional Sections') }}</span>
                        <span class="caret"></span>
                      </a>
                      <div id="about-additional-section" class="collapse @if (request()->routeIs('user.about.additional_sections') || request()->routeIs('user.about.additional_section.create') || request()->routeIs('user.about.additional_section.edit')) show @endif pl-3">
                        <ul class="nav nav-collapse subnav">
                          <li class="{{ request()->routeIs('user.about.additional_section.create') ? 'active' : '' }}">
                            <a href="{{ route('user.about.additional_section.create') }}"><span class="sub-item">{{ __('Add Section') }}</span></a>
                          </li>
                          <li class="{{ request()->routeIs('user.about.additional_sections') || request()->routeIs('user.about.additional_section.edit') ? 'active' : '' }}">
                            <a href="{{ route('user.about.additional_sections', ['language' => $defaultLang]) }}"><span class="sub-item">{{ __('Sections') }}</span></a>
                          </li>
                        </ul>
                      </div>
                    </li>
                    <li class="@if (request()->routeIs('user.about.sections.index')) active @endif">
                      <a href="{{ route('user.about.sections.index') }}"><span class="sub-item">{{ __('Section Hide/Show') }}</span></a>
                    </li>
                  </ul>
                </div>
              </li>
              ...
              <li class="submenu
                ...
                <a data-toggle="collapse" href="#blog_sidebar"
                  aria-expanded="@if (request()->routeIs('user.blog.category.index')) true @elseif(request()->routeIs('user.blog.category.edit')) true @elseif(request()->routeIs('user.blog.index')) true @elseif(request()->routeIs('user.blog.create')) true @elseif(request()->routeIs('user.blog.edit')) true @else false @endif">
                ...
                <div class="collapse
                  ...
                  id="blog_sidebar">
                  <ul class="nav nav-collapse subnav">
                    <li class="@if (request()->routeIs('user.blog.category.index')) active @elseif (request()->routeIs('user.blog.category.edit')) active @endif">
                      <a href="{{ route('user.blog.category.index') . '?language=' . $defaultLang }}"><span class="sub-item">{{ __('Categories') }}</span></a>
                    </li>
                    <li class="@if (request()->routeIs('user.blog.index')) active @elseif(request()->routeIs('user.blog.create')) active @elseif(request()->routeIs('user.blog.edit')) active @endif">
                      <a href="{{ route('user.blog.index') . '?language=' . $defaultLang }}"><span class="sub-item">{{ __('Posts') }}</span></a>
                    </li>
                  </ul>
                </div>
              </li>
              ...
              <li class="@if (request()->routeIs('user.faq.index')) active @endif">
                <a href="{{ route('user.faq.index') . '?language=' . $defaultLang }}"><span class="sub-item">{{ __('FAQs') }}</span></a>
              </li>
              <li class="@if (request()->routeIs('user.contact')) active @endif">
                <a href="{{ route('user.contact', ['language' => $defaultLang]) }}"><span class="sub-item">{{ __('Contact Page') }}</span></a>
              </li>
              <li class="@if (request()->routeIs('user.not_found_page')) active @endif">
                <a href="{{ route('user.not_found_page', ['language' => $defaultLang]) }}"><span class="sub-item">{{ __('404 Page') }}</span></a>
              </li>
              <li class="@if (request()->routeIs('user.header.index')) active @endif">
                <a href="{{ route('user.header.index') . '?language=' . $defaultLang }}"><span class="sub-item">{{ __('Top Header Section') }}</span></a>
              </li>
              @if (true)
              <li class="submenu
                ...
                <a data-toggle="collapse" href="#additionPagesSidebar"
                  aria-expanded="@if (request()->routeIs('user.page.index')) true @elseif (request()->routeIs('user.page.create')) true @elseif (request()->routeIs('user.page.edit')) true @endif">
                ...
                <div class="collapse
                  ...
                  <ul class="nav nav-collapse subnav">
                    <li class="@if (request()->routeIs('user.page.create')) active @endif">
                      <a href="{{ route('user.page.create') }}"><span class="sub-item">{{ __('Add Page') }}</span></a>
                    </li>
                    <li class="@if (request()->routeIs('user.page.index')) active @elseif(request()->routeIs('user.page.edit')) active @endif">
                      <a href="{{ route('user.page.index') . '?language=' . $defaultLang }}"><span class="sub-item">{{ __('All Pages') }}</span></a>
                    </li>
                  </ul>
                </div>
              </li>
              ...
              <li class="submenu
                ...
                <a data-toggle="collapse" href="#footerSection"
                  aria-expanded="@if (request()->routeIs('user.footer.index')) true @elseif(request()->routeIs('user.ulink.index')) true @else false @endif">
                ...
                <div class="collapse
                  ...
                  <ul class="nav nav-collapse subnav">
                    <li class="@if (request()->routeIs('user.footer.index')) active @endif">
                      <a href="{{ route('user.footer.index') . '?language=' . $defaultLang }}"><span class="sub-item">{{ __('Footer Informations') }}</span></a>
                    </li>
                    <li class="@if (request()->routeIs('user.ulink.index')) active @endif">
                      <a href="{{ route('user.ulink.index') . '?language=' . $defaultLang }}"><span class="sub-item">{{ __('Useful Links') }}</span></a>
                    </li>
                  </ul>
                </div>
              </li>
              <li class="submenu
                ...
                <a data-toggle="collapse" href="#Breadcrumbs"
                  aria-expanded="@if (request()->routeIs('user.breadcrumb')) true @elseif(request()->routeIs('user.breadcrumb.heading')) true @else false @endif">
                ...
                <div class="collapse
                  ...
                  <ul class="nav nav-collapse subnav">
                    <li class="@if (request()->routeIs('user.breadcrumb')) active @endif">
                      <a href="{{ route('user.breadcrumb', ['language' => $defaultLang]) }}"><span class="sub-item">{{ __('Image') }}</span></a>
                    </li>
                    <li class="@if (request()->routeIs('user.breadcrumb.heading')) active @endif">
                      <a href="{{ route('user.breadcrumb.heading') . '?language=' . $defaultLang }}"><span class="sub-item">{{ __('Headings') }}</span></a>
                    </li>
                  </ul>
                </div>
              </li>
              <li class="@if (request()->routeIs('user.basic_settings.seo')) active @endif">
                <a href="{{ route('user.basic_settings.seo', ['language' => $defaultLang]) }}"><span class="sub-item">{{ __('SEO Informations') }}</span></a>
              </li>
            </ul>
          </div>
        </li>
        ...
        {{-- ═══════════════════ MARKETING ═══════════════════ --}}
        @if (true)
        <li class="fl-section-label">MARKETING</li>
        ...
        {{-- ═══════════════════ FINANCEIRO ═══════════════════ --}}
        <li class="fl-section-label">FINANCEIRO</li>
